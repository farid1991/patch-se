...
a       EQU b
        ...
        defadr w_diropen,0x45453458+1
        defadr w_chdir,0x45451734+1
        defadr w_dirread,0x44F86410+1
        defadr w_dirclose,0x454536D4+1
        ...
        defadr wstrlen,0x44E68FC8+1
        defadr wstrcpy,0x44E6900C+1
        defadr wstrncpy,0x44E69024+1
        defadr wstrrchr,0x44CA5D64+1
        defadr wstrcat,0x44E6904C+1
        defadr wstrcmp,0x44E68FDC+1
        defadr wstrncmp,0x44CA5CD8+1
        defadr wstrcmpi,0x44E6A450+1
        defadr wstrwstr,0x44CA5E74+1
        defadr wstrnupr,0x44E69090+1
        defadr wstrnlwr,0x44F52304+1
        ...
        defadr FILEITEM_GetFname,0x45438F64+1
        defadr FILEITEM_GetPath,0x45438FC8+1
        defadr FSX_MakeFullPath,0x4542949C+1
        defadr FSX_FreeFullpath,0x454294EC+1
        defadr FSX_IsFileExists,0x450C5B78+1
        ...
        defadr List_Get,0x450F3CBC+1
        defadr List_InsertLast,0x450F3A7C+1
        defadr List_InsertFirst,0x450F3A6C+1
        defadr List_RemoveFirst,0x450F3AF4+1
        defadr List_RemoveAt,0x450F39F4+1
        ...
        defadr ListMenu_SetItemTextScroll,0x44FE041C+1
        ...
        defadr GUIonMessage_SetMenuItemSecondLineText,0x44FE07FC+1
        ...
        defadr DataBrowser_isFileInListExt,0x45424F2C+1
        defadr DataBrowserDesc_Create,0x450BEF8C+1
        defadr DataBrowserDesc_SetHeaderText,0x450BEF04+1
        defadr DataBrowserDesc_SetBookID,0x450BEE40+1
        defadr DataBrowserDesc_SetFolders,0x450BEEF4+1
        defadr DataBrowserDesc_SetFileExtList,0x450BEDEC+1
        defadr DataBrowserDesc_SetItemFilter,0x450BEDE4+1
        defadr DataBrowserDesc_SetFoldersNumber,0x450BEEFC+1
        defadr DataBrowserDesc_SetSelectAction,0x450BEE6C+1
	...
	defadr DataBrowserDesc_SetDefaultActions,+1
        ...
        defadr StringInput_GetStringAndLen,0x44FDD7F8+1
        defadr StringInput_MenuItem_SetPriority,0x44FDD940+1
        defadr StringInput_DispObject_SetText,0x45137DF8+1
        defadr CreateYesNoQuestion,0x45006150+1
        defadr YesNoQuestion_SetQuestionText,0x450064D8+1
        defadr YesNoQuestion_SetDescriptionText,0x450064E8+1
        defadr YesNoQuestion_SetIcon,0x45006504+1
        EXTERN GotoShortcut
