...
a       equ     b
	...
	defadr CoCreateInstance,0x117065BC+1
        ...
        defadr SaveBrightness,0x1161BC2C+1
        
        defadr Bright_Close,0x116256E4+1
        defadr Bright_LongClose,0x116256E8+1
        
        defadr SET_SECONDLINE,0x116251A0
        defadr fix_secondline,0x116251B2
