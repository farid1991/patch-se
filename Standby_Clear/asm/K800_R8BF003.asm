...
a       equ b
        ...
        defadr DataBrowserDesc_SetStyle,0x44FD21F4+1
        ...
        defadr SetMenuItemStyle,0x4541DB54+1
        defadr putchar,0x45462238+1
        ...
        defadr CreateStringInput,0x453F5C94+1
        ...
        defadr GUIObject_Softkey_SetAction,0x454806E0+1
        defadr GUIObject_Softkey_SetText,0x45480758+1
        defadr GUIObject_SoftKey_SetEnable,0x45480814+1
        defadr GUIObject_SoftKey_AddErrorStr,0x454807CC+1
        defadr GUIObject_SoftKey_RemoveItem,0x454806A4+1
        defadr GUIObject_SoftKey_SetVisible,0x454807A8+1
        defadr GUIObject_SoftKey_SuppressDefaultAction,0x45480A18+1
        ...
        defadr _strcmp,0x4467A640+1
        defadr strlen,0x4467A69C+1
        defadr wstr2strn,0x44F54A84+1
        defadr int2strID,0x4544678C+1
        defadr Str2ID,0x45446A40+1
        defadr StrID2Str,0x45446ED4+1
        defadr TextID2wstr,0x45446DC4+1
        defadr TextGetLength,0x45446CA4+1
        defadr TextFree,0x45446C08+1
        ...
        defadr List_New,0x452BF5F0+1
        defadr List_Free,0x452BF62C+1
        defadr ListElement_AddtoTop,0x452BF7A0+1
        ...
        defadr ListElement_Remove,0x452BF72C+1
        defadr GetCurrentPID,0x443ED2F0+1
        defadr ListElement_Prt2NumElement,0x452BF760+1
        ...
        defadr ListElement_Find,0x452BF9C0+1
        defadr ListElement_GetByIndex,0x452BF8C4+1
        defadr wstrrchr,0x4467B068+1
        defadr BookObj_CallSubroutine,0x453AE5C4+1
        defadr ListElement_Add,0x452BF7A8+1
        ...
        defadr GUIObject_Softkey_SetInfoText,0x45480744+1
        defadr GUIObject_Softkey_SetItemAsSubItem,0x45480838+1
        defadr REQUEST_SYSTEM_SHUTDOWN,0x453C48C8+1
        defadr REQUEST_SYSTEM_RESTART,0x453C48D8+1
        defadr GUIObject_Softkey_SetTexts,0x4548077C+1
        ...
        defadr TabMenuBar_AssignGuiObj,0x45464E00+1
        defadr TabMenuBar_SetTabIcon,0x45464E3C+1
        defadr GUIObject_Destroy,0x45463C74+1
        defadr InputFeedback_SetIcon,0x45463FF0+1
        ...
        defadr CreateFeedBack,0x453BCCF4+1
        defadr FeedBack_SetText,0x453BCDC0+1
        defadr GetBattaryState,0x44AF5378+1
        defadr get_DisplayGC,0x45461760+1
        defadr GetGuiRect,0x4545A1F4+1
        defadr get_GC_RECT,0x45461E38+1
        defadr get_GC_xx,0x4546213C+1
        defadr set_GC_xx,0x45462130+1
        defadr GC_validate_RECT,0x45461DE8+1
        ...
        defadr InvalidateRect,0x4545A060+1
        ...
        defadr BOOK_GetBookID,0x453AEEB0+1
        defadr wstrncmp,0x4467AFE0+1
        defadr DISP_OBJ_GetAbsoluteXPos,0x4545B1E4+1
        defadr DISP_OBJ_GetAbsoluteYPos,0x4545B218+1
        defadr DISP_OBJ_GetWindow,0x4545A510+1
        ...
        defadr AB_NAME_ITEM2StrID,0x44EF9F28+1
        defadr AB_NUM_ITEM2StrID,0x44EF9F70+1
        ...
        defadr DISPBASE_GetFocused,0x45459940+1
        defadr DISP_OBJ_getVisible,0x45459EF4+1
        defadr DISP_OBJ_GetDESC,0x44A1EC18+1
        defadr DISP_DESC_SetName,0x45455FA0+1
        defadr DISP_OBJ_GetName,0x4545AFA4+1
        defadr DISP_DESC_SetSize,0x45455FA4+1
        defadr DISP_DESC_SetOnCreate,0x45455FA8+1
        defadr DISP_OBJ_GetOnCreate,0x45456030+1
        defadr DISP_DESC_SetOnClose,0x45455FAC+1
        defadr DISP_OBJ_GetOnClose,0x4545604C+1
        defadr DISP_DESC_SetOnRedraw,0x45455FB0+1
        defadr DISP_OBJ_GetOnRedraw,0x45456068+1
        defadr DISP_DESC_SetOnKey,0x45455FB8+1
        defadr DISP_OBJ_GetOnKey,0x454560A0+1
        defadr DISP_DESC_SetonRefresh,0x45455FB4+1
        defadr DISP_OBJ_GetonRefresh,0x45456084+1
        defadr DISP_DESC_SetMethod06,0x45455FBC+1
        defadr DISP_OBJ_GetMethod06,0x454560BC+1
        defadr DISP_DESC_SetOnLayout,0x45455FC4+1
        defadr DISP_OBJ_GetOnLayout,0x454560F4+1
        defadr DISP_DESC_SetOnConfig,0x454560F4+1
        defadr JavaSession_Manager,0x44F707FC+1
        defadr JavaSession_GetName,0x452DE98C+1
        defadr TextCopyId,0x45446B70+1
        defadr Book_GetSession,0x453AEE50+1
        defadr GUIonMessage_SetItemAsSubitem,0x4541E674+1
        defadr GUIonMessage_SetSubitemText,0x4541E6EC+1
        defadr GUIonMessage_GetCreatedSubItemParrentIndex,0x4541E6E0+1
        ...
        defadr GUIonMessage_GetCurrentSubItem,0x4541E6D4+1
        defadr GUIonMessage_GetCurrentItemIndex,0x4541E6C8+1
        ...
        defadr TabMenuBar_GetFocusedTabIndex,0x45464D40+1
        defadr TabMenuBar_SetTabFocused,0x45464D30+1
        ...
        defadr GC_DrawBitmap,0x45461D14+1
        ...
        defadr isFmRadioBook,0x452125E5
        defadr isAudioPlayerBook,0x4504031D
        ...
        defadr List_FreeElements,0x452BFA04+1
        ...
        defadr GUIObject_HideSoftkeys,0x45480A64+1
        defadr GUIObject_ShowSoftkeys,0x45480A70+1
        ...
        defadr BookObj_Softkey_SetAction,0x4547B8CC+1
        defadr BookObj_Softkey_SetText,0x4547B904+1
        ...
        defadr BOOK_GetSessionID,0x453AEDA0+1
        ...
        defadr DispObject_SoftKey_RestoreDefaultAction,0x4547D0F8+1
        ...
        defadr DISP_OBJ_GetWindowWidth,0x4545B164+1
        defadr DISP_OBJ_GetWindowHeight,0x4545B184+1
        ...
        defadr Disp_GetStrIdWidth,0x4545DDB4+1
        ...
        defadr ListElement_Insert,0x452BF66C+1
        ...
        defadr GuiObject_SetTitleImage,0x454643F0+1
        defadr GuiObject_SetTitleIcon,0x45464398+1
        defadr GuiObject_SetHighlightImage,0x4541F108+1
        ...
        defadr isSoundRecorderBook,0x450614B5
        ...
        defadr MediaPlayer_SoftKey_SetText,0x4503FDE8+1
        defadr MediaPlayer_SoftKey_SetAction,0x4503FDB4+1
        defadr MediaPlayer_SoftKey_SetItemAsSubItem,0x4503FE74+1
        defadr MediaPlayer_SoftKey_AddHelpStr,0x4503FE04+1
        ...
        defadr GUIObject_Softkey_ExecuteAction,0x45480A44+1
        ...
        defadr DISP_OBJ_SetTitleTextColor,0x454590C0+1
        defadr DISP_OBJ_SetListTextColor,0x454109CC+1
        defadr DISP_OBJ_SetHighlightImage,0x45410988+1
        defadr DISP_OBJ_SetBackgroundImage,0x454109A4+1
        defadr DISP_OBJ_SetTitleImage,0x454590E0+1
;-------------------------------------------------------    
        defadr ListMenu_SetItemTextScroll,0x4541E22C+1
        defadr datetime2unixtime,0x4510FAD4+1
        defadr DISP_OBJ_StatusIndication_SetItemText,0x4547028C+1
        
        defadr GetOperatorName,0x44EDF29C+1
//////////////////
	EXTERN OnSetText
