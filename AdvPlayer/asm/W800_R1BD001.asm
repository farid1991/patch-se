...
a       equ b
        ...
        defadr pg_MM_Browser_Toplevel_Bk_NowPlayingStartedByChild_Start,0x45051C20+1
        defadr pg_MM_Browser_Toplevel_Bk_NowPlayingStartedByChild_Cancel,0x45051CB4+1
        defadr pg_MM_Browser_Toplevel_Bk_Videos,0x45051CEC+1
