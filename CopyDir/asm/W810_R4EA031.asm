...
a       EQU b
        ...
        defadr CreateOnOffList,0x45154390+1
        defadr OnOffList_GetSelected,0x45154574+1
        defadr OnOffList_SetChecked,0x45154380+1
        ...
        defadr DataBrowserBook_GetCurrentFoldersList,0x45249A64+1
        ...
        defadr Clipboard_SetText,0x452CC288+1

        defadr CreateMessageBox,0x45533CE0+1

        EXTERN  SoftKeys_SubItem
        EXTERN  SoftKeys_Visible

        RSEG    PATCH_DB_MANAGEFILE
        CODE16
        LDR     R3, =softkey_subitem
        BX      R3
...
softkey_subitem:
        ...
        RSEG    PATCH_DB_SOFTKEYS_VISIBLE
        CODE16
        LDR     R3, =softkey_vis
        BX      R3
