...
//////////
        defadr onBackPressed,0x11250E6C+1
        defadr onLongBackPressed,0x11250E8C+1
        
        defadr page_ServiceMenu_ViewTextLabels,0x11ADC950
        
        defadr pg_ServiceMenu_Test_Security_ExitAction,0x11250E30+1
        defadr pg_ServiceMenu_TestMenu_ReturnStandbyAction,0x11250E24+1
