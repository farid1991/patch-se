...
#define CID_CClockManager (PUUID)0x15A83988
#define IID_IClockManager (PUUID)0x15A84990
#define CID_CAlarmManager (PUUID)0x15A964EC
#define IID_IAlarmManager (PUUID)0x15ADCB98

#define GetSignalQuality_Send_SignalID 0x12C00040
#define GetSignalQuality_Receive_SignalID 0x12C007C0
#define SL_ProcessID_ptr 0x4BD4EC34
...
#define DB_LIST_M2_ICN 0xF8AC
#define DB_2ROW_PHONE_ICN 0xF8C5
#define ALARM_ON_ICN 0xF8CE
#define TIMER_ACTIVE_ICN 0xF825
#define UMTS_CALL_ICN 0x0947

// Icons
#define C_UI_3G_ICN 0x003A
#define C_UI_HSDPA_ICN 0xF489
#define C_UI_HSDPA_LOADING_ICN 0x007B
#define C_UI_HSUPA_ICN 0x007C
#define C_UI_HSUPA_LOADING_ICN 0x007D

#define SILENT_MODE_ICN 0x0868
#define C_UI_BATTERY_CHARGING_ICN 0xF430
#define C_UI_BATTERY_LEV9_ICN 0xF88B
#define C_UI_BATTERY_LEV0_ICN 0xF895
#define C_UI_EDGE_ATT_LEV0_ICN 0x003B
#define C_UI_EDGE_ATT_LEV4_ICN 0x003F
#define C_UI_EDGE_ATT_LEV5_ICN 0x004A
#define C_UI_EDGE_AVAIL_LEV4_ICN 0x004F
#define C_UI_EDGE_AVAIL_LEV5_ICN 0x005A
#define C_UI_GPRS_ATT_LEV4_ICN 0x005F
#define C_UI_GPRS_ATT_LEV5_ICN 0x006A
#define C_UI_GPRS_DET_LEV8_ICN 0x006F
#define C_UI_GPRS_DET_LEV9_ICN 0x007A
#define C_UI_RSSI_LEV0_ICN 0x007E
#define C_UI_RSSI_LEV1_ICN 0x007F
#define C_UI_RSSI_LEV2_ICN 0x008A
#define C_UI_UMA_ATT_LEV1_ICN 0x008F
#define C_UI_UMA_ATT_LEV2_ICN 0x0096
#define C_UI_UMA_ATT_LEV5_ICN 0x0099
#define FMODE_RSSI_INDICATION_ICN 0x02EE

#define CUSTOM_HIDE_NUM_ICN 0xF45F   // CIPHERING_OFF_ICN
#define CUSTOM_BY_NET_NUM_ICN 0xFFFF //
#define CUSTOM_SHOW_NUM_ICN 0xFFFF   //

#define CUSTOM_CALLERSFROMLIST_ICN 0x00D7 // CALLS_SCREENED_ICN
#define CUSTOM_NONECALLERS_ICN 0x024E     // DIVERTED_ICN
#define CUSTOM_USB_CONNECTED_ICN 0x014C   // CM_USB_BEARER_ICN

// textid
#define TEXTID_M2_NOTINSERTED 0x1412
#define TEXTID_FLIGHTMODE 0x927
#define TEXTID_SEARCHING 0xB50
#define TEXTID_ON 0x869
#define TEXTID_OFF 0x867
#define TEXTID_NORMAL 0x1D6A
#define TEXTID_ALARM_MASK 0xC4D
#define TEXTID_TIMER_MASK 0xC4F
#define TEXTID_LAYOUT 0x78E

#define CHANGE_TEXTID 0x7E6 // Измен.

// Weekday
// Shortday
#define TEXTID_SHDAY_1 0x1DFD // Mon
#define TEXTID_SHDAY_2 0x1E1E // Tue
#define TEXTID_SHDAY_3 0x1E20 // Wed
#define TEXTID_SHDAY_4 0x1E1B // Thu
#define TEXTID_SHDAY_5 0x1E0A // Fri
#define TEXTID_SHDAY_6 0x1E03 // Sat
#define TEXTID_SHDAY_7 0x1E19 // Sun
// Full day
#define TEXTID_FULLDAY_1 0x14BD // Monday
#define TEXTID_FULLDAY_2 0x14C0 // Tuesday
#define TEXTID_FULLDAY_3 0x14C1 // Wednesday
#define TEXTID_FULLDAY_4 0x14BF // Thursday 
#define TEXTID_FULLDAY_5 0x14BC // Friday
#define TEXTID_FULLDAY_6 0x14B1 // Saturday
#define TEXTID_FULLDAY_7 0x14BE // Sunday
