...
a       EQU     b
        ...
        defadr Shutdown,0x10483E60+1
        defadr Restart,0x10483E80+1
        defadr FlightGetState,0x14153F2C+1
        defadr FlightControl,0x14D755AC+1

        defadr Battery_GetChargingState,0x142DA754+1
        defadr Illumination_LedID_SetLevel,0x14518670+1
        defadr Illumination_LedID_Off,0x143A73EC+1
        
        defadr wtoi,0x1415F5B8+1
        defadr ListMenu_SetItemSecondLineText,0x142E6374+1
        
        defadr GUIObject_SetTitleIcon,0x143F2CEC+1
        defadr GUIObject_SetTitleType,0x143BD238+1
        defadr DynamicMenu_GetElementMsg,0x14153CF8+1
        defadr DynamicMenu_SetElement_SecondLineText,0x1456D8F8+1
