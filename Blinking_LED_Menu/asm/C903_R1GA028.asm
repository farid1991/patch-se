...
a       equ b
        ...
        defadr current_process,0x101E4AFC
        defadr get_bid,0x101E4B34
        ...
        defadr GUIObject_SetTitleIcon,0x14FC6AC8+1
        ...
        defadr StringInput_SetText,0x14EF71D8+1
        ...
        defadr StringInput_SetActionBack,0x1504D600+1
        ...
        defadr DynamicMenu_GetElementMsg,0x141DC6B4+1
        defadr DynamicMenu_SetElement_SecondLineText,0x1450DE3C+1

        defadr Illumination_LedID_SetLevel_Gradually,0x143E8C0C+1
        defadr Illumination_LedID_SetLevel,0x144C7088+1
        defadr Illumination_LedID_Off,0x14338188+1

        defadr Battery_GetChargingState,0x1450CED8+1
