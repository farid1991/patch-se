...
a       EQU b
	...
	defadr DEFAULT_VOLUMEONPAGENTER,0x116DFB24+1
        ...
        defadr TextID_CreateFromASCII,0x11684264+1
        ...
        defadr OLD_SOUNDRUNPAGE,0x11017AB8+1
...
// m4a
        RSEG PATCH_DB_ITEM1_M4A
        DATA
        DCD SetItemText
        RSEG PATCH_DB_ITEM2_M4A
        DATA
        DCD SetSecondlineItemText
		
		
// mp3
        RSEG PATCH_DB_ITEM1_MP3
        DATA
        DCD SetItemText
        RSEG PATCH_DB_ITEM2_MP3
        DATA
        DCD SetSecondlineItemText

// wav
/*
        RSEG PATCH_DB_ITEM1_WAV
        DATA
        DCD SetItemText
        RSEG PATCH_DB_ITEM2_WAV
        DATA
        DCD SetSecondlineItemText
*/		
// wma
        RSEG PATCH_DB_ITEM1_WMA
        DATA
        DCD SetItemText
        RSEG PATCH_DB_ITEM2_WMA
        DATA
        DCD SetSecondlineItemText
	
// ra		
        RSEG PATCH_DB_ITEM1_RA
        DATA
        DCD SetItemText
        RSEG PATCH_DB_ITEM2_RA
        DATA
        DCD SetSecondlineItemText
		
// aac		
        RSEG PATCH_DB_ITEM1_AAC
        DATA
        DCD SetItemText
        RSEG PATCH_DB_ITEM2_AAC
        DATA
        DCD SetSecondlineItemText
