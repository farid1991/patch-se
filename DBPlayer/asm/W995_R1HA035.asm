...
a       equ b
        ...
        defadr DispObject_SetThemeImage,0x144AFA74+1
        defadr GUIObject_SoftKeys_SetActionAndText,0x143F4890+1
        ...
        defadr CreateKeyGrabber,0x150A1B50+1
        defadr FILEITEM_GetFextension,0x142DBB74+1
