...
#define TEXT_ON 0x2F0         // L"Включено"
#define TEXT_OFF 0x2EF        // L"Выключено"
#define TEXT_CHANGE 0x218     // L"Внесены изменения"
#define TEXT_QUESTION 0x6F2   // L"Сохранить?"
#define TEXT_SAVE 0x120       // L"Сохранено"
#define TEXT_IMAGE 0xBFA      // L"Изображение"
#define TEXT_CANCEL 0x7BB     // L"Отменено"
#define TEXT_PLAY 0xC88       // L"Воспр."
#define TEXT_PAUSE 0xC84      // L"Пауза"
#define TEXT_TIME 0xBA4       // L"Перейти"
#define TEXT_ACTIVATE 0xF     // L"Показать"
#define TEXT_COLOR 0x24E2     // L"Цвет"
#define TEXT_COLOR_B 0x24E8   // L"Цвет фона"
#define TEXT_MODE 0x174F      // L"Режим отображ."
#define TEXT_ON_OOM 0x107     // L"????????"
#define TEXT_OFF_OOM 0x104    // L"?????????"
#define TEXT_ANIMATION 0x14CE // L"Animation"
#define TEXT_UNKNOWN 0x10A

#define CID_CMetaData (PUUID)0x15B13664
#define IID_IMetaData (PUUID)0x15B589E0
