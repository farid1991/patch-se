...
#define TEXT_MINIMISE 0xBE3       // L"Свернуть"
#define TEXT_SETTINGS 0x32D       // L"Настройки"
...
#define PGetFontDesc (FONT_DESC *)0x2A2846AC
#define PGetFontCount (int *)0x2A284A1C
