...
#define TEXT_STOP 0xCC1     // L"Стоп"
#define TEXT_MINIMISE 0x8F0 // L"Свернуть"
#define TEXT_SETTINGS 0x387 // L"Настройки"
#define TEXT_ON 0x2DF       // L"Включено"
#define TEXT_OFF 0x2DE      // L"Выключено"
#define TEXT_CHANGE 0x251   // L"Внесены изменения"
#define TEXT_QUESTION 0x89A // L"Сохранить?"
#define TEXT_SAVE 0x14B     // L"Сохранено"
#define TEXT_IMAGE 0xBFA    // L"Изображение"
#define TEXT_CANCEL 0x37F   // L"Отменено"
#define TEXT_PLAY 0xEDA     // L"Воспр."
#define TEXT_PAUSE 0xED4    // L"Пауза"
#define TEXT_TIME 0x150F    // L"Перейти"
#define TEXT_ACTIVATE 0xF   // L"Показать"
#define TEXT_COLOR 0x2348   // L"Цвет"
#define TEXT_COLOR_B 0x22F9 // L"Цвет фона"
#define TEXT_MODE 0x1A47    // L"Режим отображ."
#define TEXT_ON_OOM 0x2DF   // L"????????"
#define TEXT_OFF_OOM 0x2DE  // L"?????????"
#define TEXT_UNKNOWN 0x134

#define CID_CMetaData (PUUID)0x15C537FC
#define IID_IMetaData (PUUID)0x15C97970
