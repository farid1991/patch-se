...
void SaveSkinData(BOOK *book, wchar_t *path, wchar_t *name)
{
  ...
  int f = _fopen(path, name, FSX_O_WRONLY, FSX_S_IREAD | FSX_S_IWRITE, NULL);
  if (f >= 0)
  {
...
extern "C" void LoadPortraitData()
{
  ...
  if (Lf >= 0)
  {
    ...
    if (f >= 0)
    {
      ...
      // Shuffle_Image
      WData->Main.Shuffle_Image.x = Data->Shuffle_Image_x1;
      WData->Main.Shuffle_Image.y = Data->Shuffle_Image_y1;
      WData->Main.Shuffle_Image.Enable = Data->Shuffle_Image_Enable;

      // Loop_Image
      WData->Main.Loop_Image.x = Data->Loop_Image_x1;
      WData->Main.Loop_Image.y = Data->Loop_Image_y1;
      WData->Main.Loop_Image.Enable = Data->Loop_Image_Enable;

      // EQ_Image
      WData->Main.EQ_Image.Enable = Data->EQ_Image_Enable;
      WData->Main.EQ_Image.x = Data->EQ_Image_x1;
      WData->Main.EQ_Image.y = Data->EQ_Image_y1;

      // PlayerState_Image
      WData->Main.PlayerState_Image.x = Data->PlayerState_Image_x1;
      WData->Main.PlayerState_Image.y = Data->PlayerState_Image_y1;
      WData->Main.PlayerState_Image.Enable = Data->PlayerState_Image_Enable;

      // Title_Image
      WData->Main.Title_Image.x = Data->Title_Image_x1;
      WData->Main.Title_Image.y = Data->Title_Image_y1;
      WData->Main.Title_Image.Enable = Data->Title_Image_Enable;

      // Artist_Image
      WData->Main.Artist_Image.x = Data->Artist_Image_x1;
      WData->Main.Artist_Image.y = Data->Artist_Image_y1;
      WData->Main.Artist_Image.Enable = Data->Artist_Image_Enable;

      // Album_Image
      WData->Main.Album_Image.x = Data->Album_Image_x1;
      WData->Main.Album_Image.y = Data->Album_Image_y1;
      WData->Main.Album_Image.Enable = Data->Album_Image_Enable;

      WData->Main.WhellBG_Image.x = Data->WhellBG_Image_x1;
      WData->Main.WhellBG_Image.y = Data->WhellBG_Image_y1;
      WData->Main.WhellBG_Image.Enable = Data->WhellBG_Image_Enable;

      WData->Main.WhellUP_Image.x = Data->WhellUP_Image_x1;
      WData->Main.WhellUP_Image.y = Data->WhellUP_Image_y1;
      WData->Main.WhellUP_Image.Enable = Data->WhellUP_Image_Enable;

      WData->Main.WhellDOWN_Image.x = Data->WhellDOWN_Image_x1;
      WData->Main.WhellDOWN_Image.y = Data->WhellDOWN_Image_y1;
      WData->Main.WhellDOWN_Image.Enable = Data->WhellDOWN_Image_Enable;

      WData->Main.WhellLEFT_Image.x = Data->WhellLEFT_Image_x1;
      WData->Main.WhellLEFT_Image.y = Data->WhellLEFT_Image_y1;
      WData->Main.WhellLEFT_Image.Enable = Data->WhellLEFT_Image_Enable;

      WData->Main.WhellRIGHT_Image.x = Data->WhellRIGHT_Image_x1;
      WData->Main.WhellRIGHT_Image.y = Data->WhellRIGHT_Image_y1;
      WData->Main.WhellRIGHT_Image.Enable = Data->WhellRIGHT_Image_Enable;

      WData->Main.WhellCENTER_Image.x = Data->WhellCENTER_Image_x1;
      WData->Main.WhellCENTER_Image.y = Data->WhellCENTER_Image_y1;
      WData->Main.WhellCENTER_Image.Enable = Data->WhellCENTER_Image_Enable;

      WData->Main.Background_Image.x = Data->Background_Image_x1;
      WData->Main.Background_Image.y = Data->Background_Image_y1;
      WData->Main.Background_Image.Enable = Data->Background_Image_Enable;

      WData->Main.Overlay_Image.x = Data->Overlay_Image_x1;
      WData->Main.Overlay_Image.y = Data->Overlay_Image_y1;
      WData->Main.Overlay_Image.Enable = Data->Overlay_Image_Enable;

      // Progress Bar

      WData->Main.ProgressBar.Rect = Data->PRect;
      WData->Main.ProgressBar.BColor = Data->PBColor;
      WData->Main.ProgressBar.FColor = Data->PFColor;
      WData->Main.ProgressBar.Enable = Data->ProgressBarEnable;

      // VolumeBar
      WData->Main.VolumeBar.Rect = Data->VRect;
      WData->Main.VolumeBar.BColor = Data->VBColor;
      WData->Main.VolumeBar.FColor = Data->VFColor;
      WData->Main.VolumeBar.Enable = Data->VolumeBarEnable;
...
extern "C" void LoadLandscapeData()
{
  ...
  if (Lf >= 0)
  {
    ...
    if (f >= 0)
    {
      ...
      // Shuffle_Image
      WData->Main.Shuffle_Image.x = Data->Land_Shuffle_Image_x1;
      WData->Main.Shuffle_Image.y = Data->Land_Shuffle_Image_y1;
      WData->Main.Shuffle_Image.Enable = Data->Land_Shuffle_Image_Enable;

      // Loop_Image
      WData->Main.Loop_Image.x = Data->Land_Loop_Image_x1;
      WData->Main.Loop_Image.y = Data->Land_Loop_Image_y1;
      WData->Main.Loop_Image.Enable = Data->Land_Loop_Image_Enable;

      // EQ_Image
      WData->Main.EQ_Image.x = Data->Land_EQ_Image_x1;
      WData->Main.EQ_Image.y = Data->Land_EQ_Image_y1;
      WData->Main.EQ_Image.Enable = Data->Land_EQ_Image_Enable;

      // PlayerState_Image
      WData->Main.PlayerState_Image.x = Data->Land_PlayerState_Image_x1;
      WData->Main.PlayerState_Image.y = Data->Land_PlayerState_Image_y1;
      WData->Main.PlayerState_Image.Enable = Data->Land_PlayerState_Image_Enable;

      // Title_Image
      WData->Main.Title_Image.x = Data->Land_Title_Image_x1;
      WData->Main.Title_Image.y = Data->Land_Title_Image_y1;
      WData->Main.Title_Image.Enable = Data->Land_Title_Image_Enable;

      // Artist_Image
      WData->Main.Artist_Image.x = Data->Land_Artist_Image_x1;
      WData->Main.Artist_Image.y = Data->Land_Artist_Image_y1;
      WData->Main.Artist_Image.Enable = Data->Land_Artist_Image_Enable;

      // Album_Image
      WData->Main.Album_Image.x = Data->Land_Album_Image_x1;
      WData->Main.Album_Image.y = Data->Land_Album_Image_y1;
      WData->Main.Album_Image.Enable = Data->Land_Album_Image_Enable;

      WData->Main.WhellBG_Image.x = Data->Land_WhellBG_Image_x1;
      WData->Main.WhellBG_Image.y = Data->Land_WhellBG_Image_y1;
      WData->Main.WhellBG_Image.Enable = Data->Land_WhellBG_Image_Enable;

      WData->Main.WhellUP_Image.x = Data->Land_WhellUP_Image_x1;
      WData->Main.WhellUP_Image.y = Data->Land_WhellUP_Image_y1;
      WData->Main.WhellUP_Image.Enable = Data->Land_WhellUP_Image_Enable;

      WData->Main.WhellDOWN_Image.x = Data->Land_WhellDOWN_Image_x1;
      WData->Main.WhellDOWN_Image.y = Data->Land_WhellDOWN_Image_y1;
      WData->Main.WhellDOWN_Image.Enable = Data->Land_WhellDOWN_Image_Enable;

      WData->Main.WhellLEFT_Image.x = Data->Land_WhellLEFT_Image_x1;
      WData->Main.WhellLEFT_Image.y = Data->Land_WhellLEFT_Image_y1;
      WData->Main.WhellLEFT_Image.Enable = Data->Land_WhellLEFT_Image_Enable;

      WData->Main.WhellRIGHT_Image.x = Data->Land_WhellRIGHT_Image_x1;
      WData->Main.WhellRIGHT_Image.y = Data->Land_WhellRIGHT_Image_y1;
      WData->Main.WhellRIGHT_Image.Enable = Data->Land_WhellRIGHT_Image_Enable;

      WData->Main.WhellCENTER_Image.x = Data->Land_WhellCENTER_Image_x1;
      WData->Main.WhellCENTER_Image.y = Data->Land_WhellCENTER_Image_y1;
      WData->Main.WhellCENTER_Image.Enable = Data->Land_WhellCENTER_Image_Enable;

      WData->Main.Background_Image.x = Data->Land_Background_Image_x1;
      WData->Main.Background_Image.y = Data->Land_Background_Image_y1;
      WData->Main.Background_Image.Enable = Data->Land_Background_Image_Enable;

      WData->Main.Overlay_Image.x = Data->Land_Overlay_Image_x1;
      WData->Main.Overlay_Image.y = Data->Land_Overlay_Image_y1;
      WData->Main.Overlay_Image.Enable = Data->Land_Overlay_Image_Enable;

      // Progress Bar
      WData->Main.ProgressBar.Rect = Data->Land_PRect;
      WData->Main.ProgressBar.BColor = Data->Land_PBColor;
      WData->Main.ProgressBar.FColor = Data->Land_PFColor;
      WData->Main.ProgressBar.Enable = Data->Land_ProgressBarEnable;

      // VolumeBar
      WData->Main.VolumeBar.Rect = Data->Land_VRect;
      WData->Main.VolumeBar.BColor = Data->Land_VBColor;
      WData->Main.VolumeBar.FColor = Data->Land_VFColor;
      WData->Main.VolumeBar.Enable = Data->Land_VolumeBarEnable;
