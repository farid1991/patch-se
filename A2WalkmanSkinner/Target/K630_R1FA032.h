...
#define GetFontDesc (FONT_DESC *)0x2A27E5B0
#define GetFontCount (int *)0x2A27E920

#define CID_CMetaData (PUUID)0x1193288C
#define IID_IMetaData (PUUID)0x1195E964
#define CID_CMusicServerManager (PUUID)0x119656FC
#define IID_IMusicServerManager (PUUID)0x1193E228

#define page_MusicApplication_Main (PAGE_DESC *)0x11AF6190
#define FILE_PATH (wchar_t *)0x1192056C
...
#define MC_LANDSCAPE_ICN 0xECB7
#define MC_PORTRAIT_ICN 0xECD3
#define RN_TAB_SESSION_MANAGER_SELECTED_ICN 0xF348
#define RN_TAB_SESSION_MANAGER_DESELECTED_ICN 0xF347
