...
a       EQU b
        ...
        defadr get_VBUFFER,0x100ABCF8+1
        ...
        defadr get_IsAudioPlayerBook,0x115B8270+1
	...
	defadr CoCreateInstance,0x117065BC+1
        ...
        defadr FreeAllBook,0x1149362C+1
        ...
        defadr StringInput_SetEnableEmptyText,0x11636BBC+1
        defadr StringInput_SetActionOK,0x11636A8C+1
        defadr GUIObject_GetStyle,0x116A6CD0+1
        defadr Feedback_CloseAction,0x116B5448+1
        defadr ListMenu_SetTexts,0x1165868C+1

///////////////

        defadr IAudioPlayer_Resume,0x118F4374
        defadr IAudioPlayer_Pause,0x118F4360

        defadr MusicApplication_PrevAction,0x115B8AA8+1
        defadr MusicApplication_CancelAction,0x115B9CA4+1
        defadr MusicApplication_ShowMyMusic,0x115B9CC4+1
        defadr MusicApplication_Minimize,0x115B9C78+1
        defadr MusicApplication_Keyboard,0x115B9F9C+1
        defadr MusicApplication_SetSettings,0x115B7EDC+1

        defadr pg_MusicApplication_PreviousEvent,0x115B84DC+1
        defadr pg_MusicApplication_CancelEvent,0x115B853C+1
        defadr pg_MusicApplication_ExitEvent,0x115B85A8+1

        defadr Music_Gui_NowPlaying_OnRedraw,0x115BBCA8+1
        defadr Music_Gui_NowPlaying_OnCreate,0x115BBA14+1
        defadr Music_Gui_NowPlaying_OnClose,0x115BBC18+1

        defadr pg_MusicApplication_UI_MEDIAPLAYER_NEW_TRACK_EVENT,0x115BA450+1
        defadr pg_MusicApplication_UI_MEDIAPLAYER_AUDIO_PLAYING_TIME_EVENT,0x115BA2CC+1
        defadr pg_MusicApplication_UI_MEDIAPLAYER_CREATED_EVENT,0x115BA110+1
        defadr pg_MusicApplication_UI_MEDIAPLAYER_ENTER_EVENT,0x115B8600+1
