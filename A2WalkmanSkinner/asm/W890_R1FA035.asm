...
a       EQU b
	...
	defadr memfree,0x1009F394
        defadr memset,0x10BDEF6C+1
        defadr memcpy,0x10BDEE6C+1
        ...
        defadr List_GetCount,0x11465588+1
	...
	defadr get_IsAudioPlayerBook,0x115F8A3C+1
        ...
        defadr GUIObject_SoftKeys_AllowKeylock,0x11702848+1
        defadr GUIObject_SoftKeys_SetItemOnKey,0x11702758+1
	...
	defadr GC_DrawImage,0x116E14A4+1
        ...
        defadr StringInput_SetMinLen,0x11678B68+1
        ...
        defadr CreateMessageBox,0x1164B808+1
        defadr FSX_MakeFullPath,0x11018A18+1
        defadr FSX_FreeFullPath,0x11018A84+1
        defadr GUIObject_GetStyle,0x116E8D80+1
        defadr Feedback_CloseAction,0x116F74F8+1
        defadr ListMenu_SetTexts,0x1169A75C+1
        defadr DispObject_SetStyle,0x116E06E8+1
        defadr DispObject_GetStyle,0x116E0878+1
        defadr DispObject_SoftKeys_Show,0x116FEC88+1
        defadr DispObject_SoftKeys_Hide,0x116FEC5C+1

        defadr MusicApplication_PrevAction,0x115F93A0+1
        defadr MusicApplication_CancelAction,0x115FA618+1
        defadr MusicApplication_ShowMyMusic,0x115FA638+1
        defadr MusicApplication_Minimize,0x115FA5EC+1
        defadr MusicApplication_Keyboard,0x115FA940+1
        defadr MusicApplication_SetSettings,0x115F86A4+1

        defadr pg_MusicApplication_PreviousEvent,0x115F8D64+1
        defadr pg_MusicApplication_CancelEvent,0x115F8DC4+1
        defadr pg_MusicApplication_ExitEvent,0x115F8E7C+1

        defadr Music_Gui_NowPlaying_OnRedraw,0x115FC95C+1
        defadr Music_Gui_NowPlaying_OnCreate,0x115FC6C8+1
        defadr Music_Gui_NowPlaying_OnClose,0x115FC8CC+1

        defadr pg_MusicApplication_UI_MEDIAPLAYER_NEW_TRACK_EVENT,0x115FAE3C+1
        defadr pg_MusicApplication_UI_MEDIAPLAYER_AUDIO_PLAYING_TIME_EVENT,0x115FACB8+1
        defadr pg_MusicApplication_UI_MEDIAPLAYER_CREATED_EVENT,0x115FAAB4+1
        defadr pg_MusicApplication_UI_MEDIAPLAYER_ENTER_EVENT,0x115F8ED0+1

        defadr FeedbackTicker_OnRedraw,0x1164C4D0+1
