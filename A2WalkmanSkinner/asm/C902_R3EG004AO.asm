...
a       EQU     b
        ...
        defadr AB_NAME_ITEM2StrID,0x10B4C5B8+1
        defadr AB_NUM_ITEM2StrID,0x10B4C61C+1
        ...
        defadr ActionCreate,0x10DD3E50+1
        ...
        defadr Display_GetBrightness,0x10DA5348+1
        ...
        defadr getListMenuOnGuiDestroy,0x11A7EC70+1
        defadr getListMenuOnDescCreate,0x11A6D278+1
        defadr getListMenuOnDispMessage,0x11A7EC74+1
        defadr getTabMenuBarOnGuiDestroy,0x1177B3D8+1
        defadr getTabMenuBarOnDescCreate,0x117722D8+1
        defadr getTabMenuBarOnDispMessage,0x1177B328+1
        defadr getOneOfManyOnGuiDestroy,0x11A81244+1
        defadr getOneOfManyOnDescCreate,0x11A73B04+1
        defadr getOneOfManyOnDispMessage,0x11A81248+1
        defadr getNOfManyOnGuiDestroy,0x11A80C50+1
        defadr getNOfManyOnDescCreate,0x11A72F68+1
        defadr getNOfManyOnDispMessage,0x11A80C54+1
        ...
        defadr TextID_Create,0x10F46110+1
        defadr TextID_CreateIntegerID,0x10F45F3C+1
        defadr TextID_Destroy,0x10F4644C+1
        defadr TextID_GetLength,+1
        defadr DisplayGC_AddRef,0x109B12F4+1
        defadr GetImageHeight,0x109AE200+1
        defadr FSX_IsFileExists,0x117F75D0+1
        defadr Set_SWF_AsFlashMenu,0x10D13130+1
        defadr MainMenu_SetFromUserTheme,0x10DC1248+1
        defadr FreeURI,0x10DF50C0+1
        defadr List_GetCount,0x11AC5190+1

        defadr DispObject_SetBacklightMode,0x109AC81C+1
        defadr Disp_GetTextIDWidth,0x109AE2A0+1
        defadr GC_PutChar,0x109B18F8+1
        defadr GUIObject_SoftKeys_SetItemOnKey,0x107F32D0+1
        defadr FreeAllBook,0x10E0B1D0+1
        defadr GetImageWidth,0x109AE1EC+1
        defadr GUIObject_SoftKeys_AllowKeylock,0x107F33B0+1
        defadr CreateStringInput,0x10878C3C+1
        defadr StringInput_SetMode,0x108794F4+1
        defadr StringInput_SetFixedText,0x10879638+1
        defadr StringInput_SetMinLen,0x1087955C+1
        defadr StringInput_SetMaxLen,0x1087960C+1
        defadr StringInput_SetEnableEmptyText,0x10879680+1
        defadr StringInput_SetActionOK,0x10879550+1
        defadr FSX_MakeFullPath,0x1093C1D4+1
        defadr FSX_FreeFullPath,0x1093C240+1
        defadr CreateMessageBox,0x11A56974+1
        defadr GUIObject_GetStyle,0x109B30D4+1
        defadr Feedback_CloseAction,0x1177CAF8+1
        defadr SETTING_RINGTYPESOUNDFILE_SET,0x11A9BA18+1
        defadr Sound_SetMessageAlert,0x10C3230C+1
        defadr Sound_SetAlarmsignal,0x10916508+1
        defadr Sound_AddToContact,0x10B34FA4+1
        defadr ListMenu_SetTexts,0x11A7EF20+1

        defadr Volume_Set,0x119E084C+1
        defadr Volume_Get,0x119E0918+1
        defadr MetaData_GetTags,0x117F7BE8+1
        defadr DispObject_SetStyle,0x109ABED0+1
        defadr DispObject_GetStyle,0x109AC170+1
        defadr DispObject_SoftKeys_Show,0x107EF5F4+1
        defadr DispObject_SoftKeys_Hide,0x107EF5BC+1

        defadr MusicApplication_PrevAction,0x10C695E0+1
        defadr MusicApplication_CancelAction,0x10C6A888+1
        defadr MusicApplication_ShowMyMusic,0x10C6A8A8+1
        defadr MusicApplication_Minimize,0x10C6A854+1
        defadr MusicApplication_Keyboard,0x10C6ABAC+1

        defadr pg_MusicApplication_PreviousEvent,0x10C69058+1
        defadr pg_MusicApplication_CancelEvent,0x10C690B4+1
        defadr pg_MusicApplication_ExitEvent,0x10C6912C+1

        defadr Music_Gui_NowPlaying_OnCreate,0x10AD1228+1
        defadr Music_Gui_NowPlaying_OnClose,0x10AD1400+1
        defadr Music_Gui_NowPlaying_OnRedraw,0x10AD1488+1

        defadr pg_MusicApplication_UI_MEDIAPLAYER_NEW_TRACK_EVENT,0x10C6B140+1
        defadr pg_MusicApplication_UI_MEDIAPLAYER_AUDIO_PLAYING_TIME_EVENT,0x10C6AF44+1
        defadr pg_MusicApplication_UI_MEDIAPLAYER_CREATED_EVENT,0x10C6AD70+1
        defadr pg_MusicApplication_UI_MEDIAPLAYER_ENTER_EVENT,0x10C6916C+1

        defadr FeedbackTicker_OnRedraw,0x11A577A8+1
