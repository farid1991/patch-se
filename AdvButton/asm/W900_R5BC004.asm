...
a       equ b
        ...
        defadr png_get_io_ptr,0x210A7810+1
        defadr png_create_write_struct_2,0x210AAFCC+1
        defadr png_create_info_struct,0x210A772C+1
        defadr png_destroy_write_struct,0x210AB17C+1
        defadr png_set_IHDR,0x210AAB38+1
        defadr png_set_bgr,0x210AAD8C+1
        defadr png_set_filler,0x210AADD0+1
        defadr png_set_write_fn,0x210AAF10+1
        defadr png_write_info,0x210AAF6C+1
        defadr png_write_row,0x210AB0F0+1
        defadr png_write_end,0x210AAFA0+1
