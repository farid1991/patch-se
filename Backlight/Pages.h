...
const PAGE_MSG bk_base_msglst[] =
    {
        CANCEL_EVENT, Cancel_BasePage,
        RETURN_TO_STANDBY_EVENT, Cancel_BasePage,
        NIL_EVENT, NULL};

const PAGE_DESC BacklightControlBook_Base_Page = {"Backlight_Control_Base_Page", 0, bk_base_msglst};

const PAGE_MSG bk_main_msglst[] =
    {
        PAGE_ENTER_EVENT, BacklightControlBook_Main_Page_Enter_Event,
        NIL_EVENT, NULL};

const PAGE_DESC BacklightControlBook_Main_Page = {"BacklightControlBook_Main_Page", 0, bk_main_msglst};
