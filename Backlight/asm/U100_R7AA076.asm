...
a       EQU b
        ...
        defadr Session_SetFocus,0x14639C70+1
        ...
        defadr root_list_get_session_count,0x147AD470+1
        defadr List_Get,0x143BBB3C+1
        defadr IsVolumeControllerBook,0x142411AC+1
        defadr IsRightNowBook,0x1532271C+1
        defadr List_InsertFirst,0x142660B4+1
        defadr root_list_get_session,0x142ABA84+1
        defadr GUIonMessage_SetMenuItemIcon,0x145150A8+1
        defadr TextID_GetString,0x142AC288+1
        defadr PercentInput_GetPercent,0x14EE2F10+1
        defadr CreatePercentInputVA,0x151FC844+1
        defadr Find_StandbyBook,0x1479D610+1
        defadr TextID_CreateIntegerID,0x14512750+1
        defadr unixtime2datetime,0x147B7038+1
        defadr TextID_CreateCharacterID,0x142B1978+1
        defadr UI_Event,0x142681E4+1
        defadr GUIObject_SetSecondRowTitleText,0x1464CD40+1
        ...
        defadr GUIObject_SetBacklightTimeout,0x14008368+1
        defadr Display_SetBrightness,0x1512DBA8+1
        defadr CreateStringInputVA,0x154C3264+1
        defadr TimeInput_GetTimeInt,0x15014330+1
        defadr CreateTimeInputVA,0x151FC51C+1
        defadr GUIInput_SetIcon,0x14001ADC+1

        defadr DynamicMenu_SetElement_SecondLineText,0x147AFD2C+1
        defadr DynamicMenu_GetElementMsg,0x14570368+1
        defadr IsBook_onTop,0x145783C0+1
        defadr pg_Screensaver_Sleep,0x143D2874+1
