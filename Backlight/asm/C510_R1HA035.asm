...
a       equ b
        ...
        defadr DataBrowserDesc_SetStyle,0x1416796C+1
        ...
        defadr GUIObject_SoftKey_SetVisible,0x141C4E24+1
        ...
        defadr GetFreeBytesOnHeap,0x141B87E8+1
        ...
        defadr CreateMessage,0x140B6D2C+1
        defadr SendMessage,0x1447FB78+1
        defadr WaitMessage,0x140B6CC0+1
        defadr FreeMessage,0x1447FA18+1
        defadr SendDispatchMessage,0x142FE7FC+1
        defadr UIEventName,0x141D9518+1
        defadr MissedEvents,0x4BA1B07C
        ...
        defadr debug_printf,0x14B49D0C+1
        defadr PlayFile,0x15822774+1
        defadr REQUEST_PROFILE_GETACTIVEPROFILE,0x141ACFB0+1
        defadr Profile_SetActive,0x158901A0+1
        defadr SetBrightnessOfScreen,0x1541F2A8+1
        defadr isKeylocked,0x14071644+1
        defadr isMediaPlayerVideoBook,0x1448A269
        defadr ShuttingDown,0x14FC37D0+1
        defadr Vibra,0x1440461C+1
        ...
        defadr GetAudioControlPtr,0x4BA2CE98
        ...
        defadr InvalidateRect,0x140CA948+1
        defadr GUIObject_Create,0x144CB8B0+1
        defadr StatusRow_p,0x4BA2B924
        ...
        defadr DispObject_GetWindow,0x140CB86C+1
        ...
        defadr CreateSMSCont,0x143F7388+1
        defadr FreeSMSCont,0x1439E5E8+1
        defadr PrepareSMSCont,0x15838D44+1
        defadr CteateNewMessage,0x14E2FBE0+1
        defadr get_APP_DESC_TABLE,0x15B25D68
        defadr Window_GetComponentInterface,0x1430B570+1
        defadr AB_POSITIONNBR_GET,0x1527FD2C+1
        defadr AB_NAME_ITEM2StrID,0x1527FCDA+1
        defadr AB_NUM_ITEM2StrID,0x14E0506C+1
        defadr GetABRecNum,0x141B87EA+1
        defadr get_AB_ITEMS_DESC,0x1592DC7C
        ...
        defadr JavaSession_Manager,0x141B87E8+1
        defadr JavaSession_GetName,0x141B87E8+1
        defadr TextCopyId,0x14181E88+1
        defadr BookObj_GetSession,0x14481EB8+1
        defadr GUIonMessage_SetItemAsSubitem,0x1404B3E8+1
        defadr GUIonMessage_SetSubitemText,0x1404B288+1
        defadr GUIonMessage_GetCreatedSubItemParrentIndex,0x142D14D4+1
        defadr GoMusic,0x14F11EEC+1
        defadr Vibra_Off,0x144025F8+1
        ...
        defadr GetChipID,0x10777BA0+1
        defadr GUIonMessage_GetCurrentSubItem,0x141D4D40+1
        defadr GUIonMessage_GetCurrentItemIndex,0x15867BF0+1
        defadr DestroyDirHandle,0x14358A24+1
        defadr LastExtDB,0x15B5CE04
        ...
        defadr isFmRadioBook,0x14301DB1
        defadr isAudioPlayerBook,0x1423F7F9
        ...
        defadr GUIObject_HideSoftkeys,0x144CB138+1
        defadr GUIObject_ShowSoftkeys,0x1412982C+1
        ...
        defadr ListMenu_SetSecondLineText,0x142A8E24+1
        defadr _REQUEST_OAF_START_APPLICATION,0x140637FC+1
        defadr FSX_isNameInvalid,0x140A3C04+1
        ...
        defadr BookObj_Softkey_SetAction,0x142CE2D4+1
        defadr BookObj_Softkey_SetText,0x14C377B4+1
        ...
        defadr ActionCreate,0x1401D2F0+1
        ...
        defadr DispObject_SoftKey_RestoreDefaultAction,0x142CD6D4+1
        ...
        defadr Display_SetBrightness_A2,0x1541F1C8+1
        ...
        defadr ConnectionManager_Connection_GetState,0x144110A4+1
        defadr isCameraBook,0x14153495
        ...
        defadr CANVAS_Get_GviGC,0x14B49CAC+1
...
//////////////////
        ...
        defadr GUI_SetBacklight,0x142F0B80+1
        defadr StinpSetIcon,0x14337428+1
//------
        defadr PATCH_GUI_RET1,0x144CB99C+1
        defadr func1,0x144CB988+1

        defadr BOOK_SetFocus,0x144CB1B8+1
        
        defadr PATCH_MENU_LBL,0xC80

        defadr DefaultSleep,0x144CAFF4+1
