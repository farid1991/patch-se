...
#define GetFontDesc()  ((FONT_DESC* )0x4BBAE01C)
#define GetFontCount() ((int* )0x4BBAE38C)
#define StatusRow_p()  ((DISP_OBJ**)0x4BBD17DC)

#define GetSignalQuality_Send_SignalID 0x12C00080
#define GetSignalQuality_Receive_SignalID 0x12C007C0

#define IImageManager_guid		  ((char *)0x11EC76C0)
#define CImageManagerCreator_guid	  ((char *)0x11E9D7D0)

#define SILENT_MODE_ICN 	      0xF40E

#define C_UI_BATTERY_CHARGING_ICN     0xF430
#define C_UI_BATTERY_LEV9_ICN	      0xF88B
#define C_UI_GPRS_DET_LEV9_ICN	      0xE581
#define C_UI_RSSI_LEV0_ICN	      0xE582
#define C_UI_BATTERY_LEV0_ICN	      0xF895

#define C_UI_EDGE_ATT_LEV0_ICN	      0xE56A
#define C_UI_RSSI_LEV5_ICN	      0xE587
#define FMODE_RSSI_INDICATION_ICN     0xEB67

#define CUSTOM_HIDE_NUM_ICN	      0xF45F //CIPHERING_OFF_ICN
#define CUSTOM_BY_NET_NUM_ICN	      0xFFFF //
#define CUSTOM_SHOW_NUM_ICN	      0xFFFF //

#define CUSTOM_CALLERSFROMLIST_ICN    0xE5B9 //CALLS_SCREENED_ICN
#define CUSTOM_NONECALLERS_ICN	      0xEAE4 //DIVERTED_ICN

#define MEDIAPLAYER_RUNNING_ICN       0xED0F

#define CHANGE_TEXTID		0x9D8 //»змен.

//ƒни недели

#define TEXTID_1		0x257D	// пн
#define TEXTID_2		0x259E	// вт
#define TEXTID_3		0x25A0	// ср
#define TEXTID_4		0x259B	// чт
#define TEXTID_5		0x2576	// пт
#define TEXTID_6		0x2583	// сб
#define TEXTID_7		0x2599	// вс

#define TEXTID_F_1		0x257E	// понедельник
#define TEXTID_F_2		0x259F	// вторник
#define TEXTID_F_3		0x25A1	// среда
#define TEXTID_F_4		0x259C	// четверг
#define TEXTID_F_5		0x2577	// п€тница
#define TEXTID_F_6		0x2584	// суббота
#define TEXTID_F_7		0x259A	// воскресенье
