...
#define GetFontDesc()  ((FONT_DESC* )0x29C83D74)
#define GetFontCount() ((int* )0x29C840E4)
#define StatusRow_p()  ((DISP_OBJ**)0x29C8389C)

#define GetSignalQuality_Send_SignalID 0x12C00080
#define GetSignalQuality_Receive_SignalID 0x12C007C0

#define IImageManager_guid                ((char *)0x11999854)
#define CImageManagerCreator_guid         ((char *)0x11975B60)

#define SILENT_MODE_ICN               0xF353

#define C_UI_BATTERY_CHARGING_ICN     0xE577
#define C_UI_BATTERY_LEV9_ICN         0xF88B
#define C_UI_BATTERY_LEV0_ICN         0xF895

#define C_UI_EDGE_ATT_LEV0_ICN        0xE578
#define C_UI_GPRS_DET_LEV9_ICN        0xE58F
#define C_UI_RSSI_LEV0_ICN            0xE591
#define C_UI_RSSI_LEV5_ICN            0xE596
#define FMODE_RSSI_INDICATION_ICN     0xEB4A

#define CUSTOM_HIDE_NUM_ICN           0xEA28 //CIPHERING_OFF_ICN
#define CUSTOM_BY_NET_NUM_ICN         0xFFFF //
#define CUSTOM_SHOW_NUM_ICN           0xFFFF //

#define CUSTOM_CALLERSFROMLIST_ICN    0xE5C7 //CALLS_SCREENED_ICN
#define CUSTOM_NONECALLERS_ICN        0xEAC8 //DIVERTED_ICN

#define MEDIAPLAYER_RUNNING_ICN       0xECEE
