...
#define StatusRow_p()  ((DISP_OBJ**)0x2A285408)

#define GetSignalQuality_Send_SignalID 0x12C00080
#define GetSignalQuality_Receive_SignalID 0x12C007C0

#define IImageManager_guid                ((char *)0x11A20A70)
#define CImageManagerCreator_guid         ((char *)0x119FC63C)

#define SILENT_MODE_ICN               0xF39A
...
#define FMODE_RSSI_INDICATION_ICN     0xEB4D

#define CUSTOM_HIDE_NUM_ICN           0xEA30 //CIPHERING_OFF_ICN
#define CUSTOM_BY_NET_NUM_ICN         0xFFFF //
#define CUSTOM_SHOW_NUM_ICN           0xFFFF //

#define CUSTOM_CALLERSFROMLIST_ICN    0xE5CC //CALLS_SCREENED_ICN
#define CUSTOM_NONECALLERS_ICN        0xEACD //DIVERTED_ICN

#define CUSTOM_USB_CONNECTED_ICN      0xF440 // USB_CABLE_ICN

#define MEDIAPLAYER_RUNNING_ICN       0xECE4
