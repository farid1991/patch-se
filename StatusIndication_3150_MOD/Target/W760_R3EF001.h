...
#define GetFontDesc()  ((FONT_DESC* )0x4BBA2584)
#define GetFontCount() ((int* )0x4BBA28F4)
#define StatusRow_p()  ((DISP_OBJ**)0x4BBC5C78)

#define GetSignalQuality_Send_SignalID 0x12C00080
#define GetSignalQuality_Receive_SignalID 0x12C007C0

#define IImageManager_guid                ((char *)0x11EA6A64)
#define CImageManagerCreator_guid         ((char *)0x11E7CB8C)

#define SILENT_MODE_ICN               0xF4E0
