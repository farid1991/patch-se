...
#define StatusRow_p()  ((DISP_OBJ**)0x2AFC5334)

#define GetSignalQuality_Send_SignalID 0x12C00080
#define GetSignalQuality_Receive_SignalID 0x12C007C0

#define IImageManager_guid                ((char *)0x11EA8BB8)
#define CImageManagerCreator_guid         ((char *)0x11E7EDB0)
...
#define CHANGE_TEXTID           0x172 //»змен.
...
#define TEXTID_F_1              0x153B  // понедельник
