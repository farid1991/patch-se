...
#error C902_R3EG004AO configuration needed for this header!
#else
...
#define GetFontDesc()  ((FONT_DESC* )0x4BBAE06C)
#define GetFontCount() ((int* )0x4BBAE3DC)
#define StatusRow_p()  ((DISP_OBJ**)0x4BBD19C4)

#define GetSignalQuality_Send_SignalID 0x12C00080
#define GetSignalQuality_Receive_SignalID 0x12C007C0

#define IImageManager_guid                ((char *)0x11ED1318)
#define CImageManagerCreator_guid         ((char *)0x11EA72D0)
...
#define CHANGE_TEXTID           0x9D8 // edytuj

//Äíè íåäåëè

#define TEXTID_1                0x257D  // pon
#define TEXTID_2                0x259E  // wto
#define TEXTID_3                0x25A0  // œro
#define TEXTID_4                0x259B  // czw
#define TEXTID_5                0x2576  // pi¹
#define TEXTID_6                0x2583  // sob
#define TEXTID_7                0x2599  // nie

#define TEXTID_F_1              0x257E  // poniedzia³ek
#define TEXTID_F_2              0x259F  // wtorek
#define TEXTID_F_3              0x25A1  // œroda
#define TEXTID_F_4              0x259C  // czwartek
#define TEXTID_F_5              0x2577  // pi¹tek
#define TEXTID_F_6              0x2584  // sobota
#define TEXTID_F_7              0x259A  // niedziela
