...
a       EQU     b
        ...
        defadr ListMenu_SetItemStyle,0x11B24DA4+1
//        defadr GC_PutChar,0x10A6BE0C+1
        ...
        defadr GUIObject_SoftKeys_SetAction,0x108ABE94+1
        defadr GUIObject_SoftKeys_SetText,0x108ABF0C+1
        defadr GUIObject_SoftKeys_SetEnable,0x108ABFFC+1
        defadr GUIObject_SoftKeys_AddErrorStr,0x108ABFB4+1
        defadr GUIObject_SoftKeys_RemoveItem,0x108ABE48+1
        defadr GUIObject_SoftKeys_SetVisible,0x108ABF90+1
        defadr GUIObject_SoftKeys_SuppressDefaultAction,0x108AC200+1
        ...
        defadr REQUEST_IMAGEHANDLER_INTERNAL_GETHANDLE,0x10841058+1
        ...
        defadr GUIObject_SoftKeys_SetInfoText,0x108ABEF8+1
        defadr GUIObject_SoftKeys_SetItemAsSubItem,0x108AC030+1
        defadr REQUEST_SYSTEM_SHUTDOWN,0x11B02DE8+1
        defadr REQUEST_SYSTEM_RESTART,0x11B02DF8+1
        defadr GUIObject_SoftKeys_SetTexts,0x108ABF64+1
        ...
        defadr AudioControl_Vibrate,0x115F3018+1
        ...
        defadr DispObject_InvalidateRect,0x10A63D58+1
        ...
        defadr MainInput_strlen,0x10E2872C+1
        defadr MainInput_getPNUM,0x10E2875C+1
        ...
        defadr DispObject_GetGUI,0x10A6363C+1
        ...
        defadr DISP_DESC_SetOnConfig,0x10A60860+1
        defadr DispObject_GetOnConfig,0x10A6099C+1
        defadr DISP_DESC_SetMethod0A,0x10A60864+1
        defadr DispObject_GetMethod0A,0x10A609B8+1
        defadr DISP_DESC_SetMethod0B,0x10A60868+1
        defadr DispObject_GetMethod0B,0x10A609D4+1
        defadr DISP_DESC_SetMethod0C,0x10A6086C+1
        defadr JavaSession_GetName,0x1000592A+1
        defadr TextCopyId,0x10FFFD30+1
        defadr BookObj_GetSession,0x10E8C2B4+1
        defadr GUIonMessage_SetNumberOfSubItems,0x11B259BC+1
        defadr GUIonMessage_SubItem_SetText,0x11B25A28+1
        defadr GUIonMessage_SubItem_GetCreatedParentIndex,0x11B25A1C+1
        ...
        defadr GUIonMessage_SubItem_GetCreatedIndex,0x11B25A10+1
        defadr GUIonMessage_SubItem_GetSelectedParentIndex,0x11B25A04+1
        ...
        defadr REQUEST_IMAGEHANDLER_INTERNAL_REGISTER,0x108410D0+1
        defadr REQUEST_IMAGEHANDLER_INTERNAL_UNREGISTER,0x10841158+1
        ...
        defadr PlayerControl,0x10D2193C+1
...
//        defadr GetImageWidth,0x10A68700+1
        defadr Disp_GetStrIdHeight,0x10A68714+1 // оригинальное название GetImageHeight
        ...
        defadr GUIObject_SoftKeys_Hide,0x108AC24C+1
        defadr GUIObject_SoftKeys_Show,0x108AC258+1
        ...
        defadr MenuBook_Desktop_GetSelectedItemID,0x10E76C48+1
        defadr BookObj_SoftKeys_SetAction,0x108A64D4+1
        defadr BookObj_SoftKeys_SetText,0x108A650C+1
        ...
        defadr DispObject_SoftKeys_RestoreDefaultAction,0x108A7FF4+1
        ...
        defadr GUIObject_SetTitleIcon,0x10A6D7C0+1
        ...
        defadr GUIObject_SoftKeys_ExecuteAction,0x108AC22C+1
        defadr Request_ICA_ShutdownAllConnections,0x1153BA74+1
        ...
        defadr GVI_CreateBitmap,0x111DB648+1
        defadr GVI_CreateMemoryGC,0x111DD5BC+1
        defadr GVI_DeleteMemoryGC,0x1120B248+1
        defadr StringInput_DispObject_SetLanguage,0x1092B370+1
        ...
        defadr GUIObject_SetListTextColor,0x11B26510+1
        defadr DispObject_SetListTextColor,0x11B180F8+1
        defadr DispObject_SetCursorImage,0x11B180DC+1
        ...
        defadr YesNoQuestion_SetIcon,0x11824E28+1
        defadr GUIObject_SetBacklightTimeout,0x10A6D6C8+1
        defadr ListMenu_SetHotkeyMode,0x11B24EA4+1
        defadr ListMenu_SetSearchLanguageMode,0x11B25320+1
        defadr ListMenu_EnableSearchHeader,0x11B25348+1
        defadr GUIonMessage_GetSearchString,0x11B25AF8+1
        defadr GUIonMessage_GetSearchStringLength,0x11B25B18+1
        defadr EqualizerGain_Get,0x11A8410C+1
        defadr Theme_DestroyMenuIcons,0x10E75D00+1
        defadr MainInput_Hide,0x10E28678+1

        defadr CoCreateInstance,0x107B9770+1
        defadr DisplayGC_AddRef,0x10A6B808+1
...
//------
        ...
        defadr FlightGetState,    0x11B00B14+1
        
        defadr CallInfo_Get,      0x11312EE8+1
        defadr isTimerBook,       0x11040C9C+1

        defadr some,              0x10EAAC90+1
        defadr armfunc,           0x107928F4

        defadr Show,              0x10E29E28+1
        defadr Return_Clear,      0x10E29E22+1
        defadr Show_Clear,        0x10E29E50+1

        defadr oldRedrawStatus,   0x11818074+1
        defadr oldRedrawDisplay,  0x10E273EC+1
        defadr oldRedrawSoft,     0x108AADD0+1
        defadr oldCreateDisplay,  0x10E27380+1
        defadr oldCloseDisplay,   0x10E273D8+1
        defadr oldOnKeyMainInput, 0x10E250C0+1

        defadr retSetIcon,        0x118278D8+1
