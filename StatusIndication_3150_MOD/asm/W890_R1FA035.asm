...
a       EQU     b
        ...
        defadr SetBrightnessOfScreen,0x11666918+1
        ...
        defadr GUIObject_SoftKeys_SetTexts,0x117025EC+1
        ...
        defadr BookObj_GetBookID,0x11646178+1
        defadr wstrncmp,0x10568A3C+1
        defadr DispObject_GetAbsoluteXPos,0x116DF5FC+1
        defadr DispObject_GetAbsoluteYPos,0x116DF630+1
        defadr DispObject_GetWindow,0x116DE910+1
        ...
        defadr CreateSMSCont,0x1129ECE4+1
        defadr FreeSMSCont,0x1129F3FC+1
        defadr PrepareSMSCont,0x1129EEC0+1
        defadr CteateNewMessage,0x1129F334+1
        defadr get_APP_DESC_TABLE,0x11AB2D2C
        defadr Window_GetComponentInterface,0x116E5724+1
        defadr AB_POSITIONNBR_GET,0x10FA1D20+1
        defadr AB_NAME_ITEM2StrID,0x10FA1C34+1
        defadr AB_NUM_ITEM2StrID,0x10FA1C98+1
        defadr get_AB_ITEMS_DESC,0x11A69128
        defadr SBY_GetMainInput,0x100AC360+1
        defadr SBY_GetStatusIndication,0x112DBB64+1
        ...
        defadr JavaSession_Manager,0x11184898+1
        defadr JavaSession_GetName,0x1119909C+1
        defadr TextCopyId,0xEDA51BD1
        ...
        defadr GUIonMessage_SubItem_GetCreatedIndex,0x1169B240+1
        defadr GUIonMessage_SubItem_GetSelectedParentIndex,0x1169B234+1
        ...
        defadr GC_WritePixels,0x116E6760+1
        ...
        defadr List_DestroyElements,0x114656A8+1
        ...
        defadr ListMenu_SetSecondLineText,0x1169AA2C+1
        ...
        defadr MenuBook_Desktop_GetSelectedItemID,0x10F9F65C+1
        defadr BookObj_SoftKeys_SetAction,0x116FCCD0+1
        defadr BookObj_SoftKeys_SetText,0x116FCD08+1
        ...
        defadr ActionCreate,0x11645588+1
        ...
        defadr Disp_GetStrIdWidth,0x116E27D0+1
        ...
        defadr BookObj_SetDisplayOrientation,0x1128B66C+1
        defadr Display_GetTopBook,0x11645634+1
        defadr Display_SetBrightness,0xEDA51BD1
        defadr Display_GetBrightness,0x11667694+1
        ...
        defadr Alarm_GetState,0x10EE6CB0+1
        ...
        defadr Disp_GetStrIdHeight,0x116E2748+1
...
//------
        ...
        defadr GetOperatorName,   0x10F84B64+1
        defadr FlightGetState,    0x11650364+1
        
        defadr CallInfo_Get,      0x107E0B18+1
        defadr isTimerBook,       0x10F746B8+1

        defadr some,              0x1121A7B0+1
        defadr armfunc,           0x105649C0

        defadr Show,              0x1165275C+1
        defadr Return_Clear,      0x11652756+1
        defadr Show_Clear,        0x11652784+1

        defadr oldRedrawStatus,   0x116E3F44+1
        defadr oldRedrawDisplay,  0x116F3810+1
        defadr oldRedrawSoft,     0x11701504+1
        defadr oldCreateDisplay,  0x116F3758+1
        defadr oldCloseDisplay,   0x116F37D8+1
        defadr oldOnKeyMainInput, 0x1170DDBC+1

        defadr retSetIcon,        0x116D8CC8+1
