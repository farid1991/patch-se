...
a       EQU b
        ...
        defadr get_IsFmRadioBook,0x1132CF6C+1
        ...
        defadr Disp_GetTextIDHeight,0x116A0688+1
...
//------
        ...
        defadr CallInfo_Get,      0x107CA0AC+1
        defadr isTimerBook,       0x10F3ABD4+1

        defadr some,              0x111E00FC+1
        defadr armfunc,           0x10550BFC

        defadr Show,              0x116106B0+1
        defadr Return_Clear,      0x116106AA+1
        defadr Show_Clear,        0x116106D8+1

        defadr oldRedrawStatus,   0x116A1E94+1
        defadr oldRedrawDisplay,  0x116B1760+1
        defadr oldRedrawSoft,     0x116BF454+1
        defadr oldCreateDisplay,  0x116B16A8+1
        defadr oldCloseDisplay,   0x116B1728+1
        defadr oldOnKeyMainInput, 0x116CBCF4+1

        defadr retSetIcon,        0x11696C08+1
