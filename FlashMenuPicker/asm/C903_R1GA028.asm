...
a       EQU     b
        ...
        defadr FileCopy,0x1403F344+1
        defadr FileDelete,0x1428F930+1
        ...
        defadr MessageBox,0x158DB460+1
        defadr CreateMessageBox,0x14E9F328+1
        defadr ThemeImage_Apply,0x140A9CA8+1
        defadr MainMenu_SetFromUserTheme,0x14E62928+1
        defadr OSE_GetShell,0x14169404+1
        defadr CoCreateInstance,0x14460B7C+1

        defadr GetURIScheme,0x140B3754+1
        defadr CreateURI,0x140B3420+1
        defadr Browser_OpenURI,0x14295DD4+1
        defadr FreeURI,0x1445A41C+1
