...
a       equ b
        ...
        defadr w_diropen,0x207DB3A4+1
        defadr w_chdir,0x207D9994+1
        defadr w_dirread,0x20B2FC5C+1
        defadr w_dirclose,0x207DB5F0+1
        defadr FileDelete,0x207AB2E8+1
        defadr FileCopy,0x207AB5B8+1
        ...
        defadr DispObject_SoftKeys_SetText,0x20BC0EAC+1
        defadr DispObject_SoftKeys_SetAction,0x20BC0CA0+1
        defadr DispObject_SoftKeys_SetVisible,0x20BC0FB4+1
        defadr DispObject_SoftKeys_DefaultAction,0x20BC24D4+1
        ...
        defadr ListMenu_SetItemTextScroll,0x20B981BC+1
        ...
        defadr Set_SWF_AsFlashMenu,0x20438CD4+1
        defadr GetURIScheme,0x2070E240+1
