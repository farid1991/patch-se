...
#define DEFAULT_FLASH_PATH (wchar_t*)0x21440448
#define INT_FLASH_PATH L"/usb/image/flash"
#define EXT_FLASH_PATH L"/card/MSSEMC/Media files/image/flash"

#define MAINMENU_TXT 0x755
#define SUBMENU_TXT 0x128F
#define PREVIEW_SK_TXT 0x122D

#define ITEM_SYS_TXT 0x991
#define ITEM_INT_TXT 0x211
#define ITEM_EXT_TXT 0x210

#define ITEM_SYS_ICN 0xE856
#define ITEM_INT_ICN 0xE642
#define ITEM_EXT_ICN 0xE627
#define DB_FLASH_ICN 0xE657
