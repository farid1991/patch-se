...
a       EQU b
	...
	defadr Illumination_LedID_Off,0x115F0AF4+1
        ...
        defadr StringInput_SetMinLen,0x11636AB8+1

	defadr DynamicMenu_GetElementMsg,0x116C4FCC+1
        defadr DynamicMenu_SetElement_SecondLineText,0x116C4F90+1

////////
        defadr SetRingtoneTime,0x1127A408+1
        defadr PATCH_return1,0x1127955E+1
        defadr PATCH_return2,0x1127A0CE+1
...
MelodySelection:
	...
	ADD	R0, R0, #0
	STR	R5, [R4,#4]
	LDR	R1, =SetRingtoneTime
	LDR	R3, =PATCH_return2
	BX	R3
...
Patch_New_SK:
	...
	LDR	R2, =0x11279E20+1
	LDR	R1, =0xFAF
	LDR	R3, =PATCH_return1
	BX	R3

	RSEG PATCH_MELODY_SELECT1
        CODE16
        BX	R0
        
	RSEG PATCH_MELODY_SELECT2
        DATA
        DCD MelodySelection
