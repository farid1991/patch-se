...
a       EQU     b
        ...
        defadr FmRadio_Gui_OnCreate,0x10FAB75C+1
        defadr FmRadio_Gui_OnClose,0x10FAB810+1
        defadr FmRadio_Gui_OnKey,0x10FAB834+1
        defadr FmRadio_SetActiveSoftKeys,0x10FAD354+1
        defadr pg_FmRadio_Main__PAGE_ENTER_EVENT,0x10FACF60+1
        defadr pg_FmRadio_Base__UI_FMRADIO_CREATED_EVENT,0x10FADAF0+1
