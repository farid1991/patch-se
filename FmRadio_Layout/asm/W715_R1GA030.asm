...
a       equ b
        ...
        defadr DispObject_SetThemeImage,0x14489294+1
        defadr GUIObject_SoftKeys_SetActionAndText,0x143B0A58+1
        defadr CreateYesNoQuestion,0x142D1EA8+1
        defadr YesNoQuestion_SetDescriptionText,0x1433C204+1
        defadr YesNoQuestion_SetQuestionText,0x1433C1F4+1

        defadr FmRadio_SetActiveSoftKeys,0x1564B258+1

        defadr FmRadio_Gui_OnCreate,0x156492F4+1
        defadr FmRadio_Gui_OnClose,0x156493A4+1
        defadr FmRadio_Gui_OnRedraw,0x156495B4+1
        defadr FmRadio_Gui_OnKey,0x156493F4+1

        defadr pg_FmRadio_Main__PAGE_ENTER_EVENT,0x1564AE5C+1
