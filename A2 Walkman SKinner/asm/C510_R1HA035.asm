...
///////////////
        ...
        defadr Music_Gui_NowPlaying_OnDestroy,0x14FA9B60+1
        
        defadr DefaultOnNewTrack,0x14F4B6BC+1
        defadr Default_PATCH_UI_MEDIAPLAYER_AUDIO_PLAYING_TIME_EVENT,0x1442F898+1
        defadr Default_PATCH_UI_MEDIAPLAYER_CREATED_EVENT,0x14E0FCB8+1
        defadr pg_MusicApplication_Main_EnterAction,0x14F151B4+1
        
        EXTERN New_Music_Gui_NowPlaying_OnRedraw
        EXTERN New_Music_Gui_NowPlaying_OnCreate
        EXTERN New_Music_Gui_NowPlaying_OnDestroy
	...
	EXTERN New_pg_MusicApplication_Main_EnterAction
...
//------------------------------------------------------------------------------
	...
	DATA
	DCD New_pg_MusicApplication_Main_EnterAction
	...
	DATA
	DCD New_Music_Gui_NowPlaying_OnDestroy

	RSEG PATCH_UI_MEDIAPLAYER_AUDIO_PLAYING_TIME_EVENT_HOOK(2)
	DATA
	DCD New_PATCH_UI_MEDIAPLAYER_AUDIO_PLAYING_TIME_EVENT

        RSEG PATCH_UPDATE_ORIENTATION_HOOK_2(2)
        CODE16
	CMP     R1, R5
	BEQ     locret_143A155A
	
        RSEG PATCH_UPDATE_ORIENTATION_HOOK_3(2)
        CODE16
	CMP     R0, #0
	BEQ     Continue
