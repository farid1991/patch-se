...
a       EQU b
	...
	defadr CoCreateInstance,0x117065BC+1
        ...
        defadr GetChipID_int,0x10002964+1
        ...
        defadr MusicApp_GetFocusedItem,0x115B7D74+1
        defadr MusicApp_SetSettings,0x115B7EDC+1
...
///////////////
        ...
        defadr WALKMAN_DefaultRedraw,0x115BBCA8+1
        defadr WALKMAN_Default_ONCREATE,0x115BBA14+1
        defadr WALKMAN_Default_ONDESTROY,0x115BBC18+1
        defadr WALKMAN_Default_Method0A,0x115BBD9C+1
		
        defadr DefaultOnNewTrack,0x115BA450+1
        defadr Default_PATCH_UI_MEDIAPLAYER_AUDIO_PLAYING_TIME_EVENT,0x115BA2CC+1
        defadr Default_PATCH_UI_MEDIAPLAYER_CREATED_EVENT,0x115BA110+1	
        defadr Default_MUSIC_APP_ON_ENTER_PAGE,0x115B8600+1
        
        EXTERN New_WALKMAN_Method0A
	...
	EXTERN LoadPortraitData
        ...
        EXTERN Delete_WALKMAN_Function
...
//------------------------------------------------------------------------------
        ...
        RSEG PATCH_Delete_WALKMANFunction_HOOK(2)
	CODE16
	LDR	R3, =delete_data
	BX	R3
