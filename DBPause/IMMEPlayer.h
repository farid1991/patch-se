...
typedef struct 
{
  unsigned long Hours;		///< Number of hours.
  unsigned long Minutes;		///< Number of minutes (0 - 59).
  unsigned long Seconds;		///< Number of seconds (0 - 59).
  unsigned long MilliSeconds;	///< Number of milliseconds (0 - 999).
}TMMETime;
