...
a       equ b
        ...
        defadr SetMenuItemStyle,0x4531E4AC+1
        ...
        defadr CreateStringInput,0x452F6518+1
        ...
        defadr GUIObject_Softkey_SetAction,0x45381700+1
        defadr GUIObject_Softkey_SetText,0x45381778+1
        defadr GUIObject_SoftKey_SetEnable,0x45381834+1
        defadr GUIObject_SoftKey_AddErrorStr,0x453817EC+1
        defadr GUIObject_SoftKey_RemoveItem,0x453816C4+1
        defadr GUIObject_SoftKey_SetVisible,0x453817C8+1
        defadr GUIObject_SoftKey_SuppressDefaultAction,0x45381A38+1
        ...
        defadr int2strID,0x45347180+1
        defadr Str2ID,0x45347434+1
        defadr StrID2Str,0x453478C8+1
        defadr TextID2wstr,0x453477B8+1
        defadr TextGetLength,0x45347698+1
        defadr TextFree,0x453475FC+1
        ...
        defadr GUIObject_Softkey_SetInfoText,0x45381764+1
        defadr GUIObject_Softkey_SetItemAsSubItem,0x45381858+1
        defadr REQUEST_SYSTEM_SHUTDOWN,0x452C4668+1
        defadr REQUEST_SYSTEM_RESTART,0x452C4678+1
        defadr GUIObject_Softkey_SetTexts,0x4538179C+1
        ...
        defadr InputFeedback_SetIcon,0x45364FA4+1
        ...
        defadr CreateFeedBack,0x452BCB6C+1
        defadr FeedBack_SetText,0x452BCC38+1
        defadr GetBattaryState,0x449C5C88+1
        ...
        defadr InvalidateRect,0x4535B03C+1
        ...
        defadr GUIonMessage_SetItemAsSubitem,0x4531F034+1
        defadr GUIonMessage_SetSubitemText,0x4531F0AC+1
        defadr GUIonMessage_GetCreatedSubItemParrentIndex,0x4531F0A0+1
        ...
        defadr GUIonMessage_GetCurrentSubItem,0x4531F094+1
        defadr GUIonMessage_GetCurrentItemIndex,0x4531F088+1
        ...
        defadr GUIObject_HideSoftkeys,0x45381A84+1
        defadr GUIObject_ShowSoftkeys,0x45381A90+1
        ...
        defadr BookObj_Softkey_SetAction,0x4537C8CC+1
        defadr BookObj_Softkey_SetText,0x4537C904+1
        ...
        defadr DispObject_SoftKey_RestoreDefaultAction,0x4537E0F8+1
        ...
        defadr GUIObject_SetHighlightImage,0x4531FAC8+1
        ...
        defadr MediaPlayer_SoftKey_SetText,0x44F3490C+1
        defadr MediaPlayer_SoftKey_SetAction,0x44F348D8+1
        defadr MediaPlayer_SoftKey_SetItemAsSubItem,0x44F34998+1
        defadr MediaPlayer_SoftKey_AddHelpStr,0x44F34928+1
        ...
        defadr GUIObject_Softkey_ExecuteAction,0x45381A64+1
...
//////////////////
        defadr GetOperatorName,0x44DD1690+1
        defadr DISP_OBJ_StatusIndication_SetItemText,0x453712C0+1
