...
a       EQU b
        ...
        defadr VolumeControl_OnCreate,0x116AED1C+1
        defadr VolumeControl_OnClose,0x116AEE00+1
        defadr VolumeControl_OnRedraw,0x116AF164+1
        defadr pg_VolumeControl_Active_EnterEvent,0x116AF628+1
