...
a       equ b
        ...
        defadr MainDisplay_GetTopBook,0x142F2194+1
        defadr DispObject_WindowSetSize,0x1411751C+1

        defadr VolumeControl_OnCreate,0x14F873E8+1
        defadr VolumeControl_OnClose,0x14DA1C2C+1
        defadr VolumeControl_OnRedraw,0x14F42370+1
        defadr pg_VolumeControl_Active_EnterEvent,0x14EF53A0+1
