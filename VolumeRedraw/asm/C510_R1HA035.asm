...
a       equ b
		...
		defadr GUIonMessage_SubItem_GetSelectedIndex,0x15867BE4+1
		...
		defadr get_Surfaces,0x4BD57DB4
		...
		defadr getListMenuOnGuiDestroy,0x141532C0+1
		defadr getListMenuOnDescCreate,0x14295688+1
		defadr getListMenuOnDispMessage,0x1427FD8C+1
		defadr getTabMenuBarOnGuiDestroy,0x143A9EFC+1
		defadr getTabMenuBarOnDescCreate,0x14295B80+1
		defadr getTabMenuBarOnDispMessage,0x141282B4+1
		defadr getOneOfManyOnGuiDestroy,0x141532C0+1
		defadr getOneOfManyOnDescCreate,0x1437CAA0+1
		defadr getOneOfManyOnDispMessage,0x1418763C+1
		defadr getNOfManyOnGuiDestroy,0x15868480+1
		defadr getNOfManyOnDescCreate,0x14F90390+1
		defadr getNOfManyOnDispMessage,0x14017018+1
		...
		defadr TextID_CreateIntegerID,0x1401F5BD
		defadr TextID_Create,0x141818E5  
		defadr TextID_Copy,0x14181E89
		
		defadr DisplayGC_AddRef,0x144CDAA5
		defadr TextObject_SetText,0x14183165
		defadr TextObject_SetFont,0x1449CD75

		defadr DEFAULT_VOLUMEONREDRAW,0x140257E8+1
		defadr DEFAULT_VOLUMEONPAGENTER,0x14F295F0+1
		defadr DEFAULT_VOLUMEONPAGEXIT,0x14E6898C+1
