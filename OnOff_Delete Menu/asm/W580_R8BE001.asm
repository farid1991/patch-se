...
a       equ b
        ...
        defadr GUIObject_SoftKeyss_RemoveBackground,0x45381A9C+1
        defadr GUIObject_SoftKeyss_RestoreBackground,0x45381AA8+1
...
//////////////////
        ...
        defadr CreatePasswordInputWindow,0x44DC3FB8+1
        defadr DynamicMenu_GetElementMsg,0x4538523C+1
        defadr DynamicMenu_SetElement_SecondLineText,0x45385204+1
        defadr pg_Generic_Delete,0x44eb5298+1
        defadr pg_MarkSeveral_Delete,0x44ec6294+1
        defadr pg_Directory_Delete,0x44eb1c3C+1
