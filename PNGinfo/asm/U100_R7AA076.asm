...
a       equ b
        ...
        defadr memset,0x147ECE78
        defadr memcmp,0x147ECE04+1
        defadr memcpy,0x147ED128
        ...
        defadr strlen,0x102981C0+1
        defadr strstr,0x147ED76A+1
        defadr strcat,0x102984D0+1
        defadr strncat,0x10298304+1
        defadr strcpy,0x102982C4+1
        defadr strncpy,0x10298360+1
        ...
        defadr SUB_EXECUTE_Get_FILEITEM,0x146A1360+1
        ...
        defadr png_create_read_struct_2,0x1002F7FC+1
        defadr png_create_info_struct,0x1002FD1C+1
        defadr png_destroy_read_struct,0x10030090+1
        defadr png_get_io_ptr,0x1021B338+1
        defadr png_get_IHDR,0x1002F444+1
        defadr png_read_info,0x1021B734+1
        defadr png_set_read_fn,0x1002F75C+1
