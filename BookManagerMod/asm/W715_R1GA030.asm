...
a       equ b
        ...
        defadr ConnectionManager_Connection_GetState_int,0x14417ACC+1
        defadr GUIObject_TabTitleRemove,0x143C8338+1
        defadr FlightMode_GetState,0x141B8A88+1
        defadr FlightMode_SetState,0x144DA254+1
        defadr NewEvents_GetCount,0x1438F958+1
