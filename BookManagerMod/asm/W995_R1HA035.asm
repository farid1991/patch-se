...
a       equ b
        ...
        defadr GUIObject_TabTitleRemove,0x1400D87C+1
        ...
        defadr ConnectionManager_Connection_GetState_int,0x14481D48+1
        ...
        defadr FlightMode_GetState,0x143977A4+1
        defadr FlightMode_SetState,0x14DC5FB8+1
        ...
        defadr JavaSession_GetName,0x14EDAF14+1
        defadr manifest_GetParam,0x141AAF0C+1
        defadr NewEvents_GetCount,0x150AE234+1
