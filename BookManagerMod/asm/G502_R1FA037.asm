...
a       EQU     b
        ...
        defadr Disp_GetStrIdHeight,0x116A0688+1
        ...
        defadr Display_GetBrightness,0x11625558+1
        ...
        defadr Settings_ShowNumber_Get,0x10F4D6E0+1
	...
	defadr YesNoQuestion_CreatePreQuestion,0x116B5E78+1
	defadr YesNoQuestion_CreateQuestion,0x116B5E68+1
	...
	defadr ConnectionManager_Connection_GetState_int,0x114479B0+1
