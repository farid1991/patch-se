...
a       EQU     b
	...
	defadr TextID_GetWString,0x1416E898+1
        ...
        defadr onStandyEvent,0x15405C94+1
        defadr onCloseBook,0x14CAC7A8+1
        defadr onBackPressed,0x15404CD0+1
        defadr onLongBackPressed,0x154341C0+1
        defadr DynamicMenu_GetElementMsg,0x141DC2A4+1
        defadr DynamicMenu_SetElement_FirstLineText,0x1450D640+1
        defadr DynamicMenu_SetElement_SecondLineText,0x1450D37C+1
        defadr StandartRingMenu,0x1450D148+1
