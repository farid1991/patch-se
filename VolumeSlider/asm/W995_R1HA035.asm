...
a       equ b
        ...
        defadr DataBrowserDesc_SetItemStyle,0x15412778+1
        ...
        defadr datetime2unixtime,0x14499828+1
        ...
        defadr AB_NAME_ITEM2TextID,0x15371950+1
        defadr AB_NUM_ITEM2TextID,0x1400E8C4+1
        ...
        defadr DataBrowserDesc_SetOption,0x1426BEA0+1
        ...
        defadr getListMenuOnGuiDestroy,0x14512C98+1
        defadr getListMenuOnDescCreate,0x1450A008+1
        defadr getListMenuOnDispMessage,0x142F1644+1
        defadr getTabMenuBarOnGuiDestroy,0x143F3E1C+1
        defadr getTabMenuBarOnDescCreate,0x1450A468+1
        defadr getTabMenuBarOnDispMessage,0x14513590+1
        defadr getOneOfManyOnGuiDestroy,0x1416339C+1
        defadr getOneOfManyOnDescCreate,0x143BE9D8+1
        defadr getOneOfManyOnDispMessage,0x14167CFC+1
        defadr getNOfManyOnGuiDestroy,0x159748E4+1
        defadr getNOfManyOnDescCreate,0x1503ADF8+1
        defadr getNOfManyOnDispMessage,0x14017648+1
        ...
        defadr ListMenu_EnableSearchHeader,0x153C8658+1
        ...
        defadr BookObj_WindowSetWantsFocus,0x14F19DB0+1
        defadr BookObj_StayOnTop,0x144F7788+1
        defadr DispObject_WindowSetPosition,0x14117D30+1
        defadr DispObject_WindowSetSize,0x14118084+1
        defadr Feedback_DispObject_GetText,0x15826BF8+1
        defadr DispObject_SoftKeys_ExecuteAction,0x1439D704+1
        ...
        defadr DynamicMenu_SetElement_FirstLineText,0x1450FE90+1
        defadr DynamicMenu_SetElement_SecondLineText,0x1450FBC4+1
        defadr DynamicMenu_GetElementMsg,0x141DD838+1

        defadr onBackPressed,0x1550AB94+1
        defadr onLongBackPressed,0x1553F820+1

        defadr onCloseBook,0x14D67FA8+1
        defadr onStandyEvent,0x1550BB6C+1
        defadr StandartRingMenu,0x1450F988+1
