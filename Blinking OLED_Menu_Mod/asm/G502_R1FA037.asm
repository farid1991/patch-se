...
a       EQU b
	...
	defadr Bluetooth_Control,0x10EF6DDC+1
        ...
        defadr Charging_GetState,0x116E7C14+1
	...
	defadr DynamicMenu_GetElementMsg,0x116C4FCC+1
        ...
        defadr Registry_Read,0x1219FF10+1
        defadr Registry_Write,0x1219FE9C+1

////////

        defadr Return_Start_OLED,0x116E7584+1
        defadr UnkFunction,0x116DDCE0+1
