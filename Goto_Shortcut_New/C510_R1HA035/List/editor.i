...
int CreateMainMenu(void* data, BOOK* book)
{
  ...
  if (MainMenu)
  {
    ...
    BookObj_SoftKeys_SetText(MainMenu, 0x0, 0xB5C);
    
    BookObj_SoftKeys_SetAction(MainMenu, 0x1, Menu_SetMainMenu);
    BookObj_SoftKeys_SetText(MainMenu, 0x1, 0x1C5C);
...
int CreateJavaList(void* data, BOOK* book)
{
  ...
  GUIObject_SetTitleText(mbk->JavaMenu, 0x5D8);
...
int pg_SC_Editor_EventInput_EnterAction(void* data, BOOK* book)
{
  ...
  GUIObject_SetTitleText(mbk->EventInput, 0x103D );
...
{
  0xF, pg_SC_Editor_EventInput_EnterAction,
  0x10,  pg_SC_Editor_EventInput_ExitAction,
  0x0,        0
};
...
int pg_SC_Editor_SelectFolder_EnterAction(void* data, BOOK* book)
{
  ...
  GUIObject_SoftKeys_SetActionAndText( mbk->FolderInput, 0, SelFolder_Enter, 0x610 );
...
{
  0xF, pg_SC_Editor_SelectFolder_EnterAction,
  0x10,  pg_SC_Editor_SelectFolder_ExitAction,
  0x0,        0
};
...
int pg_SC_Editor_TypesList_EnterAction(void* data, BOOK* book)
{
  ...
  GUIObject_SetTitleText(mbk->TypesList, 0x103F);
...
{
  0xF, pg_SC_Editor_TypesList_EnterAction,
  0x10,  pg_SC_Editor_TypesList_ExitAction,
  0x0,        0
};
...
{
  0xF, pg_SC_Editor_LabelInput_EnterAction,
  0x10,  pg_SC_Editor_LabelInput_ExitAction,
  0x0,        0
};
...
int pg_SC_Editor_Main_EnterAction(void* data, BOOK* book)
{
  ...
  GUIObject_SetTitleText(mbk->Editor, 0x2755);
...
{
  0xF, pg_SC_Editor_Main_EnterAction,
  0x2,     pg_SC_Editor_Main_AcceptAction,
  0x10,  CloseEditorMenu,
  0x0,        0
};
