#line 1 "E:\\SE\\Port\\elf2vkp\\Goto_Shortcut_New\\utils.c"
...
#line 2 "E:\\SE\\Port\\elf2vkp\\Goto_Shortcut_New\\utils.c"
...
#line 3 "E:\\SE\\Port\\elf2vkp\\Goto_Shortcut_New\\utils.c"
...
#line 5 "E:\\SE\\Port\\elf2vkp\\Goto_Shortcut_New\\utils.c"
...
#line 6 "E:\\SE\\Port\\elf2vkp\\Goto_Shortcut_New\\utils.c"
...
void* SHORTCUT_DESC_A2_Init(wchar_t * param)
{
  ...
  if (!wstrcmp( w_buf->name, (wchar_t*)0x15B2C28C ))
  {
...
void OpenFolger(wchar_t * folders)
{
  ...
  DataBrowserDesc_SetHeaderText(Folder_Desc,TextID_Create(folders, ENC_UCS2, 0xFFFF));
...
void SaveConfig(LIST *List)
{
  ...
  if ((File = _fopen((wchar_t*)0x15A86E38, L"sc.bin", 0x0200|0x0004, 0x00000100|0x00000080, 0)) >= 0)
  {
    int CaptionLen = 0;
    int sDataLen = 0;
...
LIST* LoadConfig()
{
  ...
  FSTAT _fstat;
  if ((fstat((wchar_t*)0x15A86E38, L"sc.bin", &_fstat)) >= 0)
  {
    if ((File = _fopen((wchar_t*)0x15A86E38, L"sc.bin", 0x0001, 0x00000100|0x00000080, 0)) >= 0)
    {
      int CaptionLen = 0;
      int sDataLen = 0;
      u16 Count;
