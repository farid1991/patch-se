#line 1 "E:\\SE\\Port\\elf2vkp\\Goto_Shortcut_New\\FileFolder.c"
...
#line 2 "E:\\SE\\Port\\elf2vkp\\Goto_Shortcut_New\\FileFolder.c"
...
#line 3 "E:\\SE\\Port\\elf2vkp\\Goto_Shortcut_New\\FileFolder.c"
...
#line 5 "E:\\SE\\Port\\elf2vkp\\Goto_Shortcut_New\\FileFolder.c"
...
#line 6 "E:\\SE\\Port\\elf2vkp\\Goto_Shortcut_New\\FileFolder.c"
...
#line 7 "E:\\SE\\Port\\elf2vkp\\Goto_Shortcut_New\\FileFolder.c"
...
#line 8 "E:\\SE\\Port\\elf2vkp\\Goto_Shortcut_New\\FileFolder.c"

F_DATA* CreateFData()
{
  F_DATA* fdata = (F_DATA*)malloc(sizeof(F_DATA));
  memset(fdata, 0, sizeof(F_DATA));
  set_envp(0, "FList", (OSADDRESS)fdata);
  return fdata;
}

F_DATA* GetFData()
{
  F_DATA* fdata = (F_DATA*)get_envp(0, "FList");
...
int OnMessage( GUI_MESSAGE* msg )
{
  ...
  case LISTMSG_GetItem:
    ...
    str = TextID_Create(fl->name, ENC_UCS2, 0xFF);
...
void Self_OnBack( BOOK* book, GUI* gui )
{
  ...
  Free_FLIST(); if (mbk->SelectFolder) { GUIObject_Destroy(mbk->SelectFolder); mbk->SelectFolder = 0; };;
  DeleteFData();
}
...
void Self_onEnterPressed( BOOK* book, GUI* )
{
  ...
  if ( fl )
  {
    ...
    {
      TEXTID str = TextID_Create(fl->fullname, ENC_UCS2, 0xFF);
...
GUI_LIST* CreateFileFolderSelect( BOOK* book, wchar_t* str )
{
  ...
  GUIObject_SetTitleText( f_list_gui, TextID_Create(str, ENC_UCS2, 0xFF) ); //SELECT_FOLDER_TXT );
  ListMenu_SetItemCount( f_list_gui, n );
  ListMenu_SetCursorToItem( f_list_gui, 0 );
  ListMenu_SetOnMessage( f_list_gui, OnMessage );
  GUIObject_SoftKeys_SetActionAndText( f_list_gui, 0xFC2, Self_onEnterPressed, 0x531 );
  GUIObject_SoftKeys_SetActionAndText( f_list_gui, 1, Self_onSelectPressed, 0xB5C );
  GUIObject_SoftKeys_SetAction( f_list_gui, 0xFC0, Self_OnBack );
