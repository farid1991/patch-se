...
void Menu_DeleteItem(BOOK* book, GUI* gui)
{
  ...
  if(List_GetCount(mbk->Items))
  {
    ...
    YesNoQuestion_SetQuestionText(mbk->YesNoQuestion, 0x2727);
...
void Menu_ModifyItem(BOOK* book, GUI* gui)
{
  ...
  else MessageBox_NoImage(0x6FFFFFFF, 0x1544, 1, 3000, mbk);  
}
...
int pg_Goto_Shortcut_EnterAction(void* data, BOOK* book)
{
  ...
  GUIObject_SoftKeys_SetActionAndText(mbk->MainMenu, 0, Menu_AddItem, 0x22B3);
  GUIObject_SoftKeys_SetActionAndText(mbk->MainMenu, 1, Menu_ModifyItem, 0x22AE);
  GUIObject_SoftKeys_SetActionAndText(mbk->MainMenu, 2, Menu_About, 0x19ED);
...
const PAGE_MSG bk_msglst_base[] = 
{
  ...
  0x841, pg_Goto_Shortcut_CancelAction,
  0,               0
};
...
{
  0xE,  pg_Goto_Shortcut_EnterAction,
