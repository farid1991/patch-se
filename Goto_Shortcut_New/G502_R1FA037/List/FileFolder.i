...
GUI_LIST* CreateFileFolderSelect( BOOK* book, wchar_t* str )
{
  ...
  GUIObject_SoftKeys_SetActionAndText( f_list_gui, 0xFC2, Self_onEnterPressed, 0x6ED );
  GUIObject_SoftKeys_SetActionAndText( f_list_gui, 1, Self_onSelectPressed, 0x96C );
