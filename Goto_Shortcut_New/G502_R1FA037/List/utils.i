...
void* SHORTCUT_DESC_A2_Init(wchar_t * param)
{
  ...
  if (!wstrcmp( w_buf->name, (wchar_t*)0x11B66028 ))
  {
...
void SaveConfig(LIST *List)
{
  ...
  if ((File = _fopen((wchar_t*)0x11987FC4, L"sc.bin", 0x0200|0x0004, 0x00000100|0x00000080, 0)) >= 0)
  {
    int CaptionLen = 0;
    int sDataLen = 0;
...
LIST* LoadConfig()
{
  ...
  FSTAT _fstat;
  if ((fstat((wchar_t*)0x11987FC4, L"sc.bin", &_fstat)) >= 0)
  {
    if ((File = _fopen((wchar_t*)0x11987FC4, L"sc.bin", 0x0001, 0x00000100|0x00000080, 0)) >= 0)
    {
      int CaptionLen = 0;
      int sDataLen = 0;
      u16 Count;
