...
#define CID_CUIFontManager (PUUID)0x15831F58
#define IID_IUIFontManager (PUUID)0x1586D480
#define CID_CTextRenderingManager (PUUID)0x15838ECC
#define IID_ITextRenderingManager (PUUID)0x158730A4
...
#define DB_ACTION_INFO 0x1B
#define FILEINFO_TXT 0x7B3

#define ERROR_TXT 0x1684
