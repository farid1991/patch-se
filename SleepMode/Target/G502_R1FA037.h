...
#define TEXTID_1 0x1D0 // Monday
#define TEXTID_2 0x25B // Thursday
#define TEXTID_3 0x27B // Wednesday
#define TEXTID_4 0x24C // Tuesday
#define TEXTID_5 0x28F // Friday
#define TEXTID_6 0x217 // Saturday
#define TEXTID_7 0x248 // Sunday
