...
a       equ b
        ...
        defadr keyhandler_get_key,0x141CA29C+1
        defadr keyhandler_get_action,0x152C0618+1
        defadr keyhandler_action,0x14267F9C+1
        defadr def_Keyhandler,0x14267ED0+1

        EXTERN  patch_keyhandler

        RSEG    PATCH_GAMEBUTTON_A
        DATA
        DCD     KEY_PREVTRACK

        RSEG    PATCH_GAMEBUTTON_B
        DATA
        DCD     KEY_NEXTTRACK

        RSEG    PATCH_NEW_KEYHANDLER
        CODE16
        LDR     R3, =_new_keyhandler
        BX      R3
