...
{
public:
  virtual int SetControl(void *pIUIRichTextLayoutControl);                                                            // 0x10
  virtual int GetControl(void **pIUIRichTextLayoutControl);                                                           // 0x14
  virtual int SetOptions(void *pIUIRichTextLayoutOptions);                                                            // 0x18
  virtual int GetOptions(void *pIUIRichTextLayoutOptions);                                                            // 0x1C
  virtual int Subscribe(void *pICBUIRichTextLayout, u16 msgBase, int clientData, unsigned long *pSubscriptionHandle); // 0x20
  virtual int Unsubscribe(unsigned long SubscriptionHandle);                                                          // 0x24
  virtual int SetText(IRichText *pTextObject);                                                                        // 0x28
  virtual int GetText(IRichText **pTextObject);                                                                       // 0x2C
  virtual int Compose(int lineWidth);                                                                                 // 0x30
