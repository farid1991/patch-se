...
const UUID CID_CClockManager = {0x1C, 0x3F, 0x00, 0x73, 0x97, 0xA4, 0x48, 0xDF, 0x96, 0xE9, 0x5C, 0x72, 0xA6, 0xE6, 0x31, 0x4E};
const UUID IID_IClockManager = {0xB3, 0x8A, 0xA0, 0x98, 0x3B, 0xB9, 0x4E, 0x2A, 0xA1, 0xA2, 0xED, 0x3E, 0x1C, 0x6A, 0x84, 0x0C};

class IClock: public IRoot
{
public:
...
class IClockManager: public IRoot
{
public:
  virtual int CreateClock(IClock** ppIClock);
  virtual int CreateMonotonicClock(IRoot** ppIMonotonicClock);
  virtual int CreateSecureClock(IRoot** ppISecureClock);
};
