...
const UUID CID_CUIMediaCenterManager = {0xF0, 0x8A, 0xB9, 0xCA, 0xB9, 0xCA, 0x44, 0x1D, 0xAD, 0x3F, 0x0F, 0x03, 0x99, 0xDB, 0x2F, 0x26};
const UUID IID_IUIMediaCenterManager = {0xCB, 0x76, 0x32, 0x14, 0x31, 0x9C, 0x47, 0x1D, 0x99, 0xA2, 0x7D, 0x54, 0x7C, 0x3C, 0xDA, 0x9F};
...
class ICBUIMediaCenterSettings : public IRoot
{
public:
...
class IUIMediaCenterSettings : public IRoot
{
public:
...
class IUIMediaCenterManager : public IRoot
{
public:
