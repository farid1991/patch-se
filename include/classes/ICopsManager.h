...
//UUID CID_CCopsManager = {0xA8, 0xB8, 0x92, 0x61, 0xB0, 6, 0x4F, 0x5B, 0xBC, 0x57, 0xA1, 0xC6, 0xF1, 0x2C, 6, 2};
...
class ISimLock: public IUnknown
{
public:
...
class IPhoneLock: public IUnknown
{
public:
  virtual int unk_0x10();
...
class ICopsManager: public IUnknown
{
public:
