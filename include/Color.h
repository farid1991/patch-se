...
#define COLOR_GET_A(a) ((unsigned int)a>>24)
#define COLOR_GET_R(r) (((unsigned int)r>>16)&0xFF)
#define COLOR_GET_G(g) (((unsigned int)g>>8)&0xFF)
#define COLOR_GET_B(b) ((unsigned int)b&0xFF)
